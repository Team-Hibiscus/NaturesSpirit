...
public class MapleGroundTreeDecorator extends TreeDecorator {
   ...
   static {
       CODEC = RecordCodecBuilder.create((instance) -> instance.group(BlockStateProvider.CODEC.fieldOf("inner_block").forGetter((treeDecorator) -> treeDecorator.provider), BlockStateProvider.CODEC.fieldOf("outer_block").forGetter((treeDecorator) -> treeDecorator.provider2)).apply(instance, MapleGroundTreeDecorator::new));
   }
}
