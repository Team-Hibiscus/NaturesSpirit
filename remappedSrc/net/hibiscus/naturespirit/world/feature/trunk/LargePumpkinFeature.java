...
public class LargePumpkinFeature extends Feature<NoneFeatureConfiguration> {
   ...
   @Override public boolean place(FeaturePlaceContext context) {
      ...
      if (worldAccess.isEmptyBlock(origin.above()) && worldAccess.isEmptyBlock(origin.relative(direction).above()) && worldAccess.isEmptyBlock(origin.relative(direction2).above()) && worldAccess.isEmptyBlock(origin.relative(direction2).relative(direction).above()) && worldAccess.isEmptyBlock(origin) && worldAccess.isEmptyBlock(origin.relative(direction)) && worldAccess.isEmptyBlock(origin.relative(direction2)) && worldAccess.isEmptyBlock(origin.relative(direction2).relative(direction))) {
