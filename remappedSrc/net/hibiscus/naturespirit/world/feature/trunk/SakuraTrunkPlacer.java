...
public class SakuraTrunkPlacer extends TrunkPlacer {
    public static final Codec <SakuraTrunkPlacer> CODEC = RecordCodecBuilder.create((instance) -> {
        return fillTrunkPlacerFields(instance).apply(instance, SakuraTrunkPlacer::new);
    });
    ...
    public List <FoliagePlacer.TreeNode> generate(TestableWorld levelSimulatedReader, BiConsumer <BlockPos, BlockState> biConsumer, Random randomSource, int i, BlockPos blockPos, TreeFeatureConfig treeConfiguration) {
        ...
        list.add(new SakuraTrunkPlacer.FoliageCoords(blockPos.up(o), n));
    ...
    private void makeBranches(TestableWorld levelSimulatedReader, BiConsumer <BlockPos, BlockState> biConsumer, Random randomSource, int i, BlockPos blockPos, List <SakuraTrunkPlacer.FoliageCoords> list, TreeFeatureConfig treeConfiguration) {
