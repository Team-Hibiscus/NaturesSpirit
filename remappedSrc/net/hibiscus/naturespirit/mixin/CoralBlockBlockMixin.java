            ...
            if(random.nextInt(25) == 0) {
               if(world.getBlockState(pos.relative(direction, 1)).is(Blocks.WATER)) {
                  world.setBlock(pos.relative(direction, 1),
                          HibiscusBlocksAndItems.SMALL_CALCITE_BUD.defaultBlockState()
                  ...
                  world.setBlock(pos.relative(direction, 1),
                          HibiscusBlocksAndItems.LARGE_CALCITE_BUD.defaultBlockState()
                                  .setValue(AmethystClusterBlock.FACING, direction)
                                  .setValue(AmethystClusterBlock.WATERLOGGED, world.getBlockState(pos.relative(direction, 1))
                                          .getFluidState()
                                          .is(Fluids.WATER)),
                          2
                  );
                  ...
                  world.setBlock(pos.relative(direction, 1),
                          HibiscusBlocksAndItems.CALCITE_CLUSTER.defaultBlockState()
                                  .setValue(AmethystClusterBlock.FACING, direction)
                                  .setValue(AmethystClusterBlock.WATERLOGGED, world.getBlockState(pos.relative(direction, 1))
                                          .getFluidState()
                                          .is(Fluids.WATER)),
