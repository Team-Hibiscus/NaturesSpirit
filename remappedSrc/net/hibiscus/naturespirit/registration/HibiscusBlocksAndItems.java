...
public class HibiscusBlocksAndItems {
   public static final Block SANDY_SOIL = registerBlock("sandy_soil",
           new Block(FabricBlockSettings.of().mapColor(MapColor.DIRT).instrument(NoteBlockInstrument.BASEDRUM).strength(0.5F).sound(SoundType.GRAVEL)),
   ...
   public static final Block TALL_FRIGID_GRASS = registerPlantBlock("tall_frigid_grass",
           new DoublePlantBlock(FabricBlockSettings
                   .of()
   ...
   public static final Block FRIGID_GRASS = registerPlantBlock("frigid_grass",
           new HibiscusFernBlock(FabricBlockSettings
                   ...
                   .pushReaction(PushReaction.DESTROY), (DoublePlantBlock) TALL_FRIGID_GRASS),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           Blocks.FERN,
           0.3f
   );
   ...
   public static final Block SHIITAKE_MUSHROOM = registerPlantBlock("shiitake_mushroom",
           new ShiitakeMushroomPlantBlock(BlockBehaviour.Properties
                   .of()
   ...
   public static final Block SHIITAKE_MUSHROOM_BLOCK = registerBlock("shiitake_mushroom_block",
           new HugeMushroomBlock(FabricBlockSettings.of().mapColor(MapColor.DIRT).instrument(NoteBlockInstrument.BASS).strength(0.2F).sound(SoundType.WOOD).ignitedByLava()),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
   ...
   public static final Block TIGER_LILY = registerPlantBlock("tiger_lily", new LargeFlowerBlock(MobEffects.FIRE_RESISTANCE,
           7,
           FabricBlockSettings
                   .of()
                   .mapColor(MapColor.PLANT)
   ...
   public static final Block PURPLE_WILDFLOWER = registerPlantBlock("purple_wildflower", new LargeFlowerBlock(MobEffects.SLOW_FALLING,
           7,
           FabricBlockSettings
                   .of()
                   .mapColor(MapColor.PLANT)
   ...
   public static final Block YELLOW_WILDFLOWER = registerPlantBlock("yellow_wildflower", new LargeFlowerBlock(MobEffects.SLOW_FALLING,
           7,
           FabricBlockSettings
                   .of()
                   .mapColor(MapColor.PLANT)
   ...
   public static final Item LOTUS_FLOWER_ITEM = registerItem("lotus_flower",
           new PlaceOnWaterBlockItem(LOTUS_FLOWER, new Item.Properties()),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           Items.LILY_PAD,
           CreativeModeTabs.NATURAL_BLOCKS
   );
   public static final Block LOTUS_STEM = registerPlantBlock("lotus_stem", new LotusStem(
           FabricBlockSettings.of().mapColor(MapColor.COLOR_GREEN).pushReaction(PushReaction.DESTROY).noCollission().noOcclusion().instabreak().sound(SoundType.LILY_PAD),
           LOTUS_FLOWER
   ...
   public static final FoodProperties GREEN_OLIVE_COMPONENT = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.4F).build();
   public static final FoodProperties BLACK_OLIVE_COMPONENT = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.5F).build();
   ...
   public static final Block DESERT_TURNIP_ROOT_BLOCK = registerBlock("desert_turnip_root_block",
           new RotatedPillarBlock(FabricBlockSettings.of().ignitedByLava().instrument(NoteBlockInstrument.BASS).mapColor(MapColor.PODZOL).strength(2.0F).sound(SoundType.ROOTS)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           Blocks.SHROOMLIGHT,
           CreativeModeTabs.NATURAL_BLOCKS
   );
   public static final Block DESERT_TURNIP_BLOCK = registerBlock("desert_turnip_block",
           new DesertTurnipBlock(FabricBlockSettings.of().ignitedByLava().instrument(NoteBlockInstrument.BASS).mapColor(MapColor.ICE).strength(2.0F).sound(SoundType.ROOTS)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
   ...
   public static final Block DESERT_TURNIP_STEM = HibiscusRegistryHelper.registerPlantBlock("desert_turnip_stem", new DesertPlantBlock((DesertTurnipBlock) DESERT_TURNIP_BLOCK,
           ...
           FabricBlockSettings.of().noCollission().instabreak().randomTicks().sound(SoundType.GRASS).pushReaction(PushReaction.DESTROY)
   ));
   public static final FoodProperties DESERT_TURNIP_FOOD_COMPONENT = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.6F).build();
   ...
   public static final Item CHALK_POWDER = registerItem("chalk_powder", new Item((new Item.Properties())), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, Items.HONEYCOMB, CreativeModeTabs.INGREDIENTS);
   public static final Item VINEGAR_BOTTLE = registerItem("vinegar_bottle", new VinegarItem((new Item.Properties()).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, CHALK_POWDER, CreativeModeTabs.INGREDIENTS);

   public static final Block CHEESE_BLOCK = registerBlock("cheese_block", new CheeseBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SAND).strength(2.0F, 1.0F).sound(SoundType.AZALEA_LEAVES)));
   public static final Item CHEESE_BUCKET = registerItem("cheese_bucket", new SolidBucketItem(CHEESE_BLOCK, SoundEvents.BUCKET_EMPTY, (new Item.Properties()).stacksTo(1).craftRemainder(Items.BUCKET)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, Items.MILK_BUCKET, CreativeModeTabs.FOOD_AND_DRINKS);
   public static final Block MILK_CAULDRON = registerBlock("milk_cauldron", new MilkCauldronBlock(BlockBehaviour.Properties.copy(Blocks.CAULDRON).dropsLike(Blocks.CAULDRON)));
   public static final Block CHEESE_CAULDRON = registerBlock("cheese_cauldron", new CheeseCauldronBlock(BlockBehaviour.Properties.copy(Blocks.CAULDRON).dropsLike(Blocks.CAULDRON)));
   ...
   public static final Item CALCITE_SHARD = registerItem("calcite_shard", new Item(new Item.Properties()), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, Items.AMETHYST_SHARD, CreativeModeTabs.INGREDIENTS);
   public static final Block CALCITE_CLUSTER = registerBlock(
           "calcite_cluster",
           new AmethystClusterBlock(7,
                   3,
                   FabricBlockSettings.of().mapColor(MapColor.SNOW).forceSolidOn().noOcclusion().randomTicks().sound(SoundType.CALCITE).strength(1.5F).pushReaction(PushReaction.DESTROY)
           ),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
   ...
   public static final Block LARGE_CALCITE_BUD = registerBlock("large_calcite_bud",
           new AmethystClusterBlock(4, 3, FabricBlockSettings.copy(CALCITE_CLUSTER).sound(SoundType.CALCITE).forceSolidOn().pushReaction(PushReaction.DESTROY)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           CALCITE_CLUSTER,
           CreativeModeTabs.NATURAL_BLOCKS
   );
   public static final Block SMALL_CALCITE_BUD = registerBlock("small_calcite_bud",
           new AmethystClusterBlock(3, 4, FabricBlockSettings.copy(CALCITE_CLUSTER).sound(SoundType.CALCITE).forceSolidOn().pushReaction(PushReaction.DESTROY)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           LARGE_CALCITE_BUD,
           CreativeModeTabs.NATURAL_BLOCKS
   );
