...
public class HibiscusItemGroups {
   ...
   public static void registerItemGroup() {
      build(
              ...
              FabricItemGroup.builder().title(Component.translatable("itemGroup" + ".natures_spirit" + ".natures_spirit_item_group")).icon(() -> new ItemStack(HibiscusWoods.REDWOOD.getPlanks())).build()
      );
   }
