...
public class HibiscusConfiguredFeatures {
   ...
   public static void bootstrap(BootstapContext <ConfiguredFeature <?, ?>> context) {
      ...
      register(context, REDWOOD_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.REDWOOD.getLog()),
              new StraightTrunkPlacer(12, 1, 4),
              BlockStateProvider.simple(HibiscusWoods.REDWOOD.getLeaves()),
      ...
      register(
              ...
              new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.REDWOOD_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.REDWOOD_CHECKED)
              )
      );

      register(context, ASPEN_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.ASPEN.getLog()),
              new StraightTrunkPlacer(14, 2, 5),
              BlockStateProvider.simple(HibiscusWoods.ASPEN.getLeaves()),
              new AspenFoliagePlacer(UniformInt.of(2, 2), UniformInt.of(2, 3), UniformInt.of(4, 18)),
              new TwoLayersFeatureSize(1, 0, 1)
      ).ignoreVines().build());
      register(context, ASPEN_TREE_BEES, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.ASPEN.getLog()),
              new StraightTrunkPlacer(14, 2, 5),
              BlockStateProvider.simple(HibiscusWoods.ASPEN.getLeaves()),
              new AspenFoliagePlacer(UniformInt.of(2, 2), UniformInt.of(2, 3), UniformInt.of(4, 18)),
              new TwoLayersFeatureSize(1, 0, 1)
      ...
      register(
              ...
              ASPEN_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.ASPEN_BEES_CHECKED), 0.01f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.ASPEN_CHECKED)
              )
      );

      register(context, RED_MAPLE_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.MAPLE.getLog()),
              ...
              BlockStateProvider.simple(HibiscusWoods.MAPLE.getRedMapleLeaves()),
              new MapleFoliagePlacer(ConstantInt.of(4), ConstantInt.of(0), ConstantInt.of(5), 0.26666667F, 0.53333334F),
              new TwoLayersFeatureSize(1, 0, 2)
      ).ignoreVines().decorators(ImmutableList.of(new MapleGroundTreeDecorator(SimpleStateProvider.simple(Blocks.PODZOL), SimpleStateProvider.simple(Blocks.COARSE_DIRT)))).build());
      register(context, ORANGE_MAPLE_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.MAPLE.getLog()),
              ...
              BlockStateProvider.simple(HibiscusWoods.MAPLE.getOrangeMapleLeaves()),
              new MapleFoliagePlacer(ConstantInt.of(4), ConstantInt.of(0), ConstantInt.of(5), 0.26666667F, 0.53333334F),
              new TwoLayersFeatureSize(1, 0, 2)
      ).ignoreVines().decorators(ImmutableList.of(new MapleGroundTreeDecorator(SimpleStateProvider.simple(Blocks.PODZOL), SimpleStateProvider.simple(Blocks.COARSE_DIRT)))).build());
      register(context, YELLOW_MAPLE_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.MAPLE.getLog()),
              new MapleTrunkPlacer(
                      9,
                      2,
                      0,
              ...
              BlockStateProvider.simple(HibiscusWoods.MAPLE.getYellowMapleLeaves()),
              new MapleFoliagePlacer(ConstantInt.of(4), ConstantInt.of(0), ConstantInt.of(5), 0.26666667F, 0.53333334F),
              new TwoLayersFeatureSize(1, 0, 2)
      ).ignoreVines().decorators(ImmutableList.of(new MapleGroundTreeDecorator(SimpleStateProvider.simple(Blocks.PODZOL), SimpleStateProvider.simple(Blocks.COARSE_DIRT)))).build());
      ...
      register(context,
              ...
              new SimpleRandomFeatureConfiguration(HolderSet.direct(placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.RED_MAPLE_CHECKED),
      ...
      register(context, CYPRESS_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.CYPRESS.getLog()),
              new StraightTrunkPlacer(11, 1, 2),
              BlockStateProvider.simple(HibiscusWoods.CYPRESS.getLeaves()),
              new CypressFoliagePlacer(UniformInt.of(2, 2), UniformInt.of(3, 3), UniformInt.of(11, 13)),
              new TwoLayersFeatureSize(1, 0, 1)
      ).ignoreVines().build());


      register(context, FIR_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.FIR.getLog()),
              new StraightTrunkPlacer(10, 1, 2),
              BlockStateProvider.simple(HibiscusWoods.FIR.getLeaves()),
      ...
      register(context,
              FIR_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.FIR_CHECKED), 0.5f)),
      ...
      register(context, LARGE_REDWOOD_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.REDWOOD.getLog()),
      ...
      register(
              ...
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.LARGE_REDWOOD_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.LARGE_REDWOOD_CHECKED)
              )
      );


      register(context, WILLOW_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.WILLOW.getLog()),
              new FancyTrunkPlacer(10, 3, 5),
              BlockStateProvider.simple(HibiscusWoods.WILLOW.getLeaves()),
              ...
              new HibiscusSimpleBlockStateProvider(HibiscusWoods.WILLOW.getWillowVinesPlant().defaultBlockState()),
              new RandomizedIntStateProvider(BlockStateProvider.simple(HibiscusWoods.WILLOW.getWillowVines().defaultBlockState()), WisteriaVine.AGE, UniformInt.of(23, 25)),
              5
      ))).ignoreVines().build());
      register(context,
              WILLOW_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.WILLOW_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.WILLOW_CHECKED)
              )
      );


      register(context, WHITE_WISTERIA_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.WISTERIA.getLog()),
              ...
              BlockStateProvider.simple(HibiscusWoods.WISTERIA.getWhiteWisteriaLeaves()),
              new WisteriaFoliagePlacer(ConstantInt.of(1), ConstantInt.of(0)),
              new TwoLayersFeatureSize(2, 0, 2)
      ).decorators(List.of(new WisteriaVinesTreeDecorator(0.45F,
              new HibiscusSimpleBlockStateProvider(HibiscusWoods.WISTERIA.getWhiteWisteriaVinesPlant().defaultBlockState()),
              new RandomizedIntStateProvider(BlockStateProvider.simple(HibiscusWoods.WISTERIA.getWhiteWisteriaVines().defaultBlockState()), WisteriaVine.AGE, UniformInt.of(22, 25)),
              2
      ))).ignoreVines().build());

      register(context, PINK_WISTERIA_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.WISTERIA.getLog()),
              ...
              BlockStateProvider.simple(HibiscusWoods.WISTERIA.getPinkWisteriaLeaves()),
              new WisteriaFoliagePlacer(ConstantInt.of(1), ConstantInt.of(0)),
              new TwoLayersFeatureSize(2, 0, 2)
      ).decorators(List.of(new WisteriaVinesTreeDecorator(0.45F,
              new HibiscusSimpleBlockStateProvider(HibiscusWoods.WISTERIA.getPinkWisteriaVinesPlant().defaultBlockState()),
              new RandomizedIntStateProvider(BlockStateProvider.simple(HibiscusWoods.WISTERIA.getPinkWisteriaVines().defaultBlockState()), WisteriaVine.AGE, UniformInt.of(22, 25)),
              2
      ))).ignoreVines().build());

      register(context, BLUE_WISTERIA_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.WISTERIA.getLog()),
              new WisteriaTrunkPlacer(7,
                      3,
                      4,
                      UniformInt.of(1, 6),
              ...
              BlockStateProvider.simple(HibiscusWoods.WISTERIA.getBlueWisteriaLeaves()),
              new WisteriaFoliagePlacer(ConstantInt.of(1), ConstantInt.of(0)),
              new TwoLayersFeatureSize(2, 0, 2)
      ).decorators(List.of(new WisteriaVinesTreeDecorator(0.45F,
              new HibiscusSimpleBlockStateProvider(HibiscusWoods.WISTERIA.getBlueWisteriaVinesPlant().defaultBlockState()),
              new RandomizedIntStateProvider(BlockStateProvider.simple(HibiscusWoods.WISTERIA.getBlueWisteriaVines().defaultBlockState()), WisteriaVine.AGE, UniformInt.of(22, 25)),
              2
      ))).ignoreVines().build());

      register(context, PURPLE_WISTERIA_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.WISTERIA.getLog()),
              new WisteriaTrunkPlacer(7,
                      3,
                      4,
                      UniformInt.of(1, 6),
              ...
              BlockStateProvider.simple(HibiscusWoods.WISTERIA.getPurpleWisteriaLeaves()),
              new WisteriaFoliagePlacer(ConstantInt.of(1), ConstantInt.of(0)),
              new TwoLayersFeatureSize(2, 0, 2)
      ).decorators(List.of(new WisteriaVinesTreeDecorator(0.45F,
              new HibiscusSimpleBlockStateProvider(HibiscusWoods.WISTERIA.getPurpleWisteriaVinesPlant().defaultBlockState()),
              new RandomizedIntStateProvider(BlockStateProvider.simple(HibiscusWoods.WISTERIA.getPurpleWisteriaVines().defaultBlockState()), WisteriaVine.AGE, UniformInt.of(22, 25)),
              2
      ))).ignoreVines().build());
      ...
      register(
              ...
              WISTERIA_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.WHITE_WISTERIA_CHECKED), 0.10f),
      ...
      register(context, SUGI_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.SUGI.getLog()),
              new SugiTrunkPlacer(10, 1, 1, UniformInt.of(4, 6), .85F, UniformInt.of(4, 5), BuiltInRegistries.BLOCK.getOrCreateTag(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)),
              BlockStateProvider.simple(HibiscusWoods.SUGI.getLeaves()),
      ...
      register(context,
              SUGI_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.SUGI_CHECKED), 0.325f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.SUGI_CHECKED)
              )
      );

      register(context, OLIVE_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(HibiscusWoods.OLIVE.getLog()),
              new OliveTrunkPlacer(4, 1, 2, UniformInt.of(4, 6), .85F, UniformInt.of(4, 5), BuiltInRegistries.BLOCK.getOrCreateTag(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)),
              BlockStateProvider.simple(HibiscusWoods.OLIVE.getLeaves()),
      ...
      register(context,
              OLIVE_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.OLIVE_CHECKED), 0.325f)),
      ...
      register(
              ...
              JOSHUA_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.JOSHUA_CHECKED), 0.325f)),
      ...
      register(
              ...
              CYPRESS_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureRegistryEntryLookup.getOrThrow(HibiscusPlacedFeatures.CYPRESS_CHECKED), 0.325f)),
      ...
      register(context,
              ...
              new HugeMushroomFeatureConfiguration(BlockStateProvider.simple(HibiscusBlocksAndItems.SHIITAKE_MUSHROOM_BLOCK.defaultBlockState().setValue(HugeMushroomBlock.UP, true).setValue(HugeMushroomBlock.DOWN, false)),
      ...
      register(context,
              ...
              new RandomPatchConfiguration(32, 7, 3, PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(HibiscusBlocksAndItems.SCORCHED_GRASS))))
      );
      register(context,
      ...
      register(context,
              ...
              new RandomPatchConfiguration(90,
                      ...
                      PlacementUtils.filtered(Feature.SIMPLE_BLOCK,
                              ...
                              BlockPredicate.allOf(BlockPredicate.wouldSurvive(HibiscusBlocksAndItems.CATTAIL.defaultBlockState(), BlockPos.ZERO), BlockPredicate.ONLY_IN_AIR_OR_WATER_PREDICATE, BlockPredicate.anyOf(
      ...
      register(context,
              ...
              new TurnipRootFeatureConfig(PlacementUtils.inlinePlaced(Feature.NO_BONEMEAL_FLOWER, new RandomPatchConfiguration(30, 3, 2, PlacementUtils.inlinePlaced(Feature.SIMPLE_BLOCK,
                      new SimpleBlockConfiguration(BlockStateProvider.simple(HibiscusBlocksAndItems.DESERT_TURNIP_STEM.defaultBlockState().setValue(DesertPlantBlock.AGE, 7))),
                      ...
                      BlockPredicate.allOf(
                              BlockPredicate.anyOf(BlockPredicate.matchesBlocks(List.of(Blocks.AIR, Blocks.CAVE_AIR, Blocks.VOID_AIR)), BlockPredicate.matchesTag(BlockTags.REPLACEABLE)),
                              BlockPredicate.matchesTag(Direction.DOWN.getNormal(), HibiscusTags.Blocks.TURNIP_STEM_GROWS_ON)
                      )
              )
      );
