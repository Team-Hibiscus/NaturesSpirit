...
public class HibiscusPlacedFeatures {
   ...
   public static void bootstrap(BootstapContext <PlacedFeature> context) {
      ...
      registerKey(context,
              ...
              List.of(PlacementUtils.filteredByBlockSurvival(HibiscusWoods.REDWOOD_SAPLING[0]))
      );
      registerKey(context,
              REDWOOD_CHECKED,
              configuredFeatureRegistryEntryLookup.getOrThrow(HibiscusConfiguredFeatures.REDWOOD_TREE),
              PlacementUtils.filteredByBlockSurvival(HibiscusWoods.REDWOOD_SAPLING[0])
      );
      registerKey(context,
              ASPEN_CHECKED,
              configuredFeatureRegistryEntryLookup.getOrThrow(HibiscusConfiguredFeatures.ASPEN_TREE),
              PlacementUtils.filteredByBlockSurvival(HibiscusWoods.ASPEN_SAPLING[0])
      );
      registerKey(context,
              ASPEN_BEES_CHECKED,
