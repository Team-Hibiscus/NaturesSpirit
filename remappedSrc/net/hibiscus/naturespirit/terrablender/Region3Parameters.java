...
public class Region3Parameters {
   ...
   public Region3Parameters() {
      ...
      this.commonBiomes = new ResourceKey[][]{
              {
                      ...
                      Biomes.SAVANNA, Biomes.SAVANNA, HibiscusBiomes.SUGI_FOREST, HibiscusBiomes.SUGI_FOREST, HibiscusBiomes.SUGI_FOREST
              }, {
                      Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, Biomes.DESERT, Biomes.DESERT
              }
      };
      this.uncommonBiomes = new ResourceKey[][]{
              {Biomes.ICE_SPIKES, null, Biomes.SNOWY_TAIGA, null, null}, {HibiscusBiomes.MARIGOLD_MEADOWS, null, null, null, null}, {
              Biomes.SUNFLOWER_PLAINS, null, null, Biomes.OLD_GROWTH_BIRCH_FOREST, null
      }, {
                      null, null, Biomes.PLAINS, null, null
      ...
      this.nearMountainBiomes = new ResourceKey[][]{
              {
                      ...
                      Biomes.SAVANNA_PLATEAU, Biomes.SAVANNA_PLATEAU, Biomes.FOREST, HibiscusBiomes.SUGI_FOREST, HibiscusBiomes.SUGI_FOREST
              }, {
      ...
      this.specialNearMountainBiomes = new ResourceKey[][]{
              ...
              null, HibiscusBiomes.MARIGOLD_MEADOWS, null, null, null
      }, {
   ...
   private void writeValleyBiomes(Consumer <Pair <Climate.ParameterPoint, ResourceKey <Biome>>> parameters, Climate.Parameter weirdness) {
      ...
      this.writeBiomeParameters(parameters, this.nonFrozenTemperatureParameters, this.defaultParameter, this.coastContinentalness, this.erosionParameters[6], weirdness, 0.0F, Biomes.RIVER);
      this.writeBiomeParameters(parameters,
              Climate.Parameter.span(this.temperatureParameters[1], this.temperatureParameters[2]),
              this.defaultParameter,
