...
public class Region5Parameters {
   ...
   public Region5Parameters() {
      ...
      this.erodedRiverTemperatureParameters = Climate.Parameter.span(this.temperatureParameters[1],
              this.temperatureParameters[2]
      );
      this.riverTemperatureParameters = Climate.Parameter.span(this.temperatureParameters[3],
              this.temperatureParameters[4]
      );
