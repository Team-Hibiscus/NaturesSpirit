...
public class Region1Parameters {
   ...
   public Region1Parameters() {
      ...
      this.uncommonBiomes = new ResourceKey[][]{
              {Biomes.ICE_SPIKES, null, Biomes.SNOWY_TAIGA, null, null}, {null, null, null, null, null}, {
      ...
      this.nearMountainBiomes = new ResourceKey[][]{
              {
                      ...
                      Biomes.MEADOW, HibiscusBiomes.PRAIRIE, HibiscusBiomes.PRAIRIE, HibiscusBiomes.FIR_FOREST, HibiscusBiomes.REDWOOD_FOREST
              }, {
