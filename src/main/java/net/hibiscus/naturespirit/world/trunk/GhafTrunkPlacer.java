...
public class GhafTrunkPlacer extends TrunkPlacer {
   ...
   public GhafTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight, IntProvider extraBranchSteps, float placeBranchPerLogProbability, IntProvider extraBranchLength, RegistryEntryList <Block> canGrowThrough) {
   ...
   protected TrunkPlacerType <?> getType() {
      return HibiscusWorldGen.GHAF_TRUNK_PLACER;
   }
