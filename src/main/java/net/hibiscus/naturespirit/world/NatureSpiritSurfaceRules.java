...
public class NatureSpiritSurfaceRules {
   ...
   public static MaterialRules.MaterialRule makeRules() {
      ...
      MaterialRules.MaterialCondition materialCondition4 = MaterialRules.aboveY(YOffset.fixed(63), 0); MaterialRules.MaterialCondition above25 = MaterialRules.aboveY(YOffset.fixed(
              25), -1); MaterialRules.MaterialCondition above62 = MaterialRules.aboveY(YOffset.fixed(62), 0);
      MaterialRules.MaterialCondition chalkGrassCondition = MaterialRules.aboveY(YOffset.fixed(65), 0); MaterialRules.MaterialCondition materialCondition5 = MaterialRules.water(-1,
              0
      ); MaterialRules.MaterialCondition materialCondition6 = MaterialRules.aboveY(YOffset.fixed(60), 0);
      MaterialRules.MaterialCondition materialCondition7 = MaterialRules.water(0, 0); MaterialRules.MaterialCondition holeCondition = MaterialRules.hole();
      MaterialRules.MaterialCondition noiseCondition1 = MaterialRules.noiseThreshold(NoiseParametersKeys.SURFACE, -0.909D, -0.5454D);
      MaterialRules.MaterialCondition noiseCondition2 = MaterialRules.noiseThreshold(
      ...
      MaterialRules.MaterialRule stratifiedDesertRule = MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.STRATIFIED_DESERT),
              MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, MaterialRules.sequence(MaterialRules.condition(materialCondition, CHERT),
                      ...
                      MaterialRules.condition(materialCondition5, MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_CEILING, CHERT), SANDY_SOIL)),
              ...
              MaterialRules.condition(belowWater, MaterialRules.sequence(MaterialRules.condition(STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH, SANDY_SOIL),
              ...
              MaterialRules.condition(belowWater,
                      MaterialRules.sequence(MaterialRules.condition(MaterialRules.noiseThreshold(NoiseParametersKeys.PATCH, 0.0),
                                      MaterialRules.sequence(MaterialRules.condition(STONE_DEPTH_FLOOR, GRASS),
      ...
      MaterialRules.MaterialRule desertSteppeRule = MaterialRules.sequence(MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.ARID_HIGHLANDS),
              MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, MaterialRules.sequence(MaterialRules.condition(materialCondition, CHERT),
                      MaterialRules.condition(materialCondition3, MaterialRules.sequence(MaterialRules.condition(noiseCondition3, SANDY_SOIL), MaterialRules.terracottaBands())),
                      MaterialRules.condition(materialCondition5, MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_CEILING, CHERT), PINK_SAND)),
                      MaterialRules.condition(MaterialRules.not(holeCondition), CHERT),
      ...
      MaterialRules.MaterialRule shrubbySteppeRule = MaterialRules.sequence(MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.SHRUBBY_HIGHLANDS),
              MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, MaterialRules.sequence(MaterialRules.condition(materialCondition, CHERT),
                      MaterialRules.condition(materialCondition3, MaterialRules.sequence(MaterialRules.condition(noiseCondition3, SANDY_SOIL),
                              MaterialRules.condition(MaterialRules.not(above80), MaterialRules.sequence(MaterialRules.condition(noiseCondition6, GRASS))),
      ...
      MaterialRules.MaterialRule woodySteppeRule = MaterialRules.sequence(MaterialRules.condition(
              MaterialRules.biome(HibiscusBiomes.WOODY_HIGHLANDS, HibiscusBiomes.BLOOMING_HIGHLANDS),
              MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, MaterialRules.sequence(MaterialRules.condition(materialCondition, CHERT),
                      MaterialRules.condition(materialCondition3, MaterialRules.sequence(MaterialRules.condition(noiseCondition3, GRASS),
                              MaterialRules.condition(MaterialRules.not(above76), MaterialRules.sequence(MaterialRules.condition(noiseCondition6, SANDY_SOIL))),
                              MaterialRules.terracottaBands()
                      )),
                      MaterialRules.condition(materialCondition5, MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_CEILING, CHERT), GRASS)),
                      MaterialRules.condition(MaterialRules.not(holeCondition), CHERT),
                      MaterialRules.condition(belowWater, CHERT)
      ...
      MaterialRules.MaterialRule snowySteppeRule = MaterialRules.sequence(MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.SLEETED_SLOPES,
              HibiscusBiomes.SNOWCAPPED_RED_PEAKS
      ), MaterialRules.sequence(MaterialRules.condition(MaterialRules.steepSlope(), CHERT),
              ...
              MaterialRules.condition(STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH, MaterialRules.condition(belowWater, CHERT))
      )), MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.SLEETED_SLOPES), MaterialRules.sequence(powderSnow)));

      MaterialRules.MaterialRule steppeUndergroundRule = MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.SLEETED_SLOPES,
              HibiscusBiomes.BLOOMING_HIGHLANDS,
              HibiscusBiomes.SNOWCAPPED_RED_PEAKS,
              HibiscusBiomes.SHRUBBY_HIGHLANDS,
              HibiscusBiomes.WOODY_HIGHLANDS,
              HibiscusBiomes.ARID_HIGHLANDS
      ...
      MaterialRules.MaterialRule chalkCliffsRule = MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.WHITE_CLIFFS),
              MaterialRules.sequence(MaterialRules.condition(chalkGrassCondition,
                      MaterialRules.sequence(MaterialRules.condition(MaterialRules.stoneDepth(0, false, VerticalSurfaceType.FLOOR), GRASS),
                              MaterialRules.condition(MaterialRules.stoneDepth(1, false, VerticalSurfaceType.FLOOR), DIRT)
                      )
              ))
      );

      MaterialRules.MaterialRule dustyRule = MaterialRules.sequence(MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.DUSTY_SLOPES, HibiscusBiomes.RED_PEAKS),
              MaterialRules.sequence(MaterialRules.condition(MaterialRules.steepSlope(), CHERT),
              ...
              MaterialRules.sequence(MaterialRules.condition(MaterialRules.aboveY(YOffset.fixed(60), -1), WHITE_CHALK),
              ...
              MaterialRules.sequence(MaterialRules.condition(above62,
                      MaterialRules.sequence(MaterialRules.condition(MaterialRules.stoneDepth(0, false, VerticalSurfaceType.FLOOR), GRASS),
                              MaterialRules.condition(MaterialRules.stoneDepth(4, false, VerticalSurfaceType.FLOOR),
                                      MaterialRules.sequence(MaterialRules.condition(noiseCondition2, ROOTED_DIRT), MaterialRules.condition(noiseCondition3, ROOTED_DIRT), DIRT)
                              )
                      )
              ), MaterialRules.condition(MaterialRules.stoneDepth(36, false, VerticalSurfaceType.FLOOR), GRANITE))
      ); MaterialRules.MaterialRule drylandsRule = MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.DRYLANDS), MaterialRules.condition(belowWater, MaterialRules.sequence(
              MaterialRules.condition(STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH, pinkSandstoneOrPinkSand),
              MaterialRules.condition(STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH_RANGE_30, PINK_SANDSTONE)
      ))); MaterialRules.MaterialRule scorchedDunesRule = MaterialRules.condition(
              MaterialRules.biome(HibiscusBiomes.SCORCHED_DUNES),
              MaterialRules.condition(belowWater, MaterialRules.sequence(
                      MaterialRules.condition(STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH,
                              MaterialRules.sequence(MaterialRules.condition(noiseCondition4, redSandstoneOrRedSand), chertOrSoil)
                      ),
              ...
              MaterialRules.condition(belowWater, MaterialRules.condition(STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH, MaterialRules.condition(noiseCondition4, pinkSandstoneOrSoil)))
      ); MaterialRules.MaterialRule shoresRule = MaterialRules.condition(
              MaterialRules.biome(HibiscusBiomes.TROPICAL_SHORES),
              MaterialRules.condition(belowWater, MaterialRules.sequence(MaterialRules.condition(STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH, pinkSandstoneOrPinkSand),
              ...
              MaterialRules.condition(belowWater, MaterialRules.condition(STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH, MaterialRules.condition(noiseCondition4, travertineOrSoil)))
      ); MaterialRules.MaterialRule aridRule = MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.ARID_SAVANNA),
              MaterialRules.condition(belowWater, MaterialRules.condition(STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH, MaterialRules.condition(noiseCondition4, chertOrSoil)))
      ); MaterialRules.MaterialRule tundraRule = MaterialRules.condition(
              belowWater,
              MaterialRules.condition(
                      STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH,
                      MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.SNOWY_FIR_FOREST, HibiscusBiomes.TUNDRA, HibiscusBiomes.BOREAL_TAIGA), MaterialRules.sequence(
                              MaterialRules.condition(noiseCondition4,
                                      MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.TUNDRA, HibiscusBiomes.BOREAL_TAIGA), stoneOrMoss)
                              ),
                              MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.SNOWY_FIR_FOREST, HibiscusBiomes.TUNDRA),
                                      MaterialRules.condition(noiseCondition5, stoneOrSnow)
                              )
                      ))
              )
      ); MaterialRules.MaterialRule tropicalBasinRule = MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR,
              MaterialRules.sequence(MaterialRules.condition(MaterialRules.biome(HibiscusBiomes.MARSH, HibiscusBiomes.TROPICAL_BASIN, HibiscusBiomes.BAMBOO_WETLANDS),
                      MaterialRules.condition(materialCondition6, MaterialRules.condition(MaterialRules.not(materialCondition4),
      ...
      builder.add(chaparralSurfaceRule); builder.add(livelyDunesSurfaceRule); builder.add(chalkCliffsSurfaceRule); builder.add(chalkUndergroundRule); builder.add(drylandsSurfaceRule); builder.add(woodedDrylandsSurfaceRule); builder.add(shoresSurfaceRule);
      builder.add(xericSurfaceRule); builder.add(aridSurfaceRule); builder.add(tundraSurfaceRule); builder.add(tropicalBasinSurfaceRule); builder.add(scorchedDunesSurfaceRule);
      builder.add(aspenSurfaceRule); builder.add(desertSteppeSurfaceRule); builder.add(shrubbySteppeSurfaceRule); builder.add(woodySteppeSurfaceRule); builder.add(
              snowySteppeSurfaceRule); builder.add(steppeUndergroundRule); return MaterialRules.sequence(builder.build().toArray(MaterialRules.MaterialRule[]::new));
   }
