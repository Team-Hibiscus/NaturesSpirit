...
public class HibiscusDeltaFeature extends Feature <DeltaFeatureConfig> {
   ...
   static {
      CANNOT_REPLACE = ImmutableList.of(
              ...
              Blocks.CHEST,
              Blocks.SPAWNER,
              HibiscusWoods.WISTERIA.getBlueLeaves(),
              HibiscusWoods.WISTERIA.getPurpleLeaves(),
              HibiscusWoods.WISTERIA.getWhiteLeaves(),
              HibiscusWoods.WISTERIA.getPinkLeaves(),
              HibiscusWoods.WILLOW.getLeaves()
      );
      CAN_REPLACE = ImmutableList.of(Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.GRASS_BLOCK, Blocks.MUD, Blocks.SAND, HibiscusMiscBlocks.PINK_SAND);
