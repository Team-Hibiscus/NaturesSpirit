         ...
         if(l >= offset - 2) {
            ...
            if(random.nextBoolean()) {
               ...
               placeFoliageBlock(world,
                       ...
                       random,
                       config,
                       mutable.offset(m.getOpposite(), 1).offset(n.getOpposite(), 1)
               );
            }
            if(random.nextBoolean()) {
               Direction m = random.nextBoolean() ? Direction.NORTH : Direction.SOUTH;
            ...
            placeFoliageBlock(world,
                    ...
                    random,
                    config,
                    mutable.offset(Direction.NORTH, 2).offset(Direction.EAST, 1)
            );
            placeFoliageBlock(world,
                    placer,
                    random,
                    config,
                    mutable.offset(Direction.NORTH, 2).offset(Direction.WEST, 1)
            );
            placeFoliageBlock(world,
                    placer,
                    random,
                    config,
                    mutable.offset(Direction.EAST, 2).offset(Direction.NORTH, 1)
            );
            placeFoliageBlock(world,
                    placer,
                    random,
                    config,
                    mutable.offset(Direction.EAST, 2).offset(Direction.SOUTH, 1)
            );
            placeFoliageBlock(world,
                    placer,
                    random,
                    config,
                    mutable.offset(Direction.SOUTH, 2).offset(Direction.EAST, 1)
            );
            placeFoliageBlock(world,
                    placer,
                    random,
                    config,
                    mutable.offset(Direction.SOUTH, 2).offset(Direction.WEST, 1)
            );
            placeFoliageBlock(world,
                    placer,
                    random,
                    config,
                    mutable.offset(Direction.WEST, 2).offset(Direction.NORTH, 1)
            );
            placeFoliageBlock(world,
                    placer,
                    random,
                    config,
                    mutable.offset(Direction.WEST, 2).offset(Direction.SOUTH, 1)
            );
            this.generateSquare(world, placer, random, config, blockPos, 1, l, treeNode.isGiantTrunk());
         }
         else if(l == offset - 11) {
