...
public class HibiscusBlocks {
    ...
    public static final Block PASTEL = registerBlock("pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, Blocks.PINK_TERRACOTTA, ItemGroups.COLORED_BLOCKS);
    public static final Block WHITE_PASTEL = registerBlock("white_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block LIGHT_GRAY_PASTEL = registerBlock("light_gray_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_LIGHT_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.WHITE_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block GRAY_PASTEL = registerBlock("gray_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.LIGHT_GRAY_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block BLACK_PASTEL = registerBlock("black_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_BLACK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.GRAY_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block BROWN_PASTEL = registerBlock("brown_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_BROWN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.BLACK_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block RED_PASTEL = registerBlock("red_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_RED).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.BROWN_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block ORANGE_PASTEL = registerBlock("orange_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.RED_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block YELLOW_PASTEL = registerBlock("yellow_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.ORANGE_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block LIME_PASTEL = registerBlock("lime_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_LIME).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.YELLOW_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block GREEN_PASTEL = registerBlock("green_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_GREEN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.LIME_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block CYAN_PASTEL = registerBlock("cyan_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_CYAN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.GREEN_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block LIGHT_BLUE_PASTEL = registerBlock("light_blue_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_LIGHT_BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.CYAN_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block BLUE_PASTEL = registerBlock("blue_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.LIGHT_BLUE_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block PURPLE_PASTEL = registerBlock("purple_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_PURPLE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.BLUE_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block MAGENTA_PASTEL = registerBlock("magenta_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_MAGENTA).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.PURPLE_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block PINK_PASTEL = registerBlock("pink_pastel", new Block(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_PINK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.MAGENTA_PASTEL, ItemGroups.COLORED_BLOCKS);

    public static final Block PASTEL_STAIRS = registerBlock("pastel_stairs", new StairsBlock(PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.PINK_PASTEL, ItemGroups.COLORED_BLOCKS);
    public static final Block WHITE_PASTEL_STAIRS = registerBlock("white_pastel_stairs", new StairsBlock(WHITE_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block LIGHT_GRAY_PASTEL_STAIRS = registerBlock("light_gray_pastel_stairs", new StairsBlock(LIGHT_GRAY_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_LIGHT_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.WHITE_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block GRAY_PASTEL_STAIRS = registerBlock("gray_pastel_stairs", new StairsBlock(GRAY_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.LIGHT_GRAY_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block BLACK_PASTEL_STAIRS = registerBlock("black_pastel_stairs", new StairsBlock(BLACK_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_BLACK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.GRAY_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block BROWN_PASTEL_STAIRS = registerBlock("brown_pastel_stairs", new StairsBlock(BROWN_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_BROWN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.BLACK_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block RED_PASTEL_STAIRS = registerBlock("red_pastel_stairs", new StairsBlock(RED_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_RED).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.BROWN_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block ORANGE_PASTEL_STAIRS = registerBlock("orange_pastel_stairs", new StairsBlock(ORANGE_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.RED_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block YELLOW_PASTEL_STAIRS = registerBlock("yellow_pastel_stairs", new StairsBlock(YELLOW_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.ORANGE_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block LIME_PASTEL_STAIRS = registerBlock("lime_pastel_stairs", new StairsBlock(LIME_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_LIME).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.YELLOW_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block GREEN_PASTEL_STAIRS = registerBlock("green_pastel_stairs", new StairsBlock(GREEN_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_GREEN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.LIME_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block CYAN_PASTEL_STAIRS = registerBlock("cyan_pastel_stairs", new StairsBlock(CYAN_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_CYAN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.GREEN_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block LIGHT_BLUE_PASTEL_STAIRS = registerBlock("light_blue_pastel_stairs", new StairsBlock(LIGHT_BLUE_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_LIGHT_BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.CYAN_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block BLUE_PASTEL_STAIRS = registerBlock("blue_pastel_stairs", new StairsBlock(BLUE_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.LIGHT_BLUE_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block PURPLE_PASTEL_STAIRS = registerBlock("purple_pastel_stairs", new StairsBlock(PURPLE_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_PURPLE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.BLUE_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block MAGENTA_PASTEL_STAIRS = registerBlock("magenta_pastel_stairs", new StairsBlock(MAGENTA_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_MAGENTA).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.PURPLE_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block PINK_PASTEL_STAIRS = registerBlock("pink_pastel_stairs", new StairsBlock(PINK_PASTEL.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_PINK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.MAGENTA_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);

    public static final Block PASTEL_SLAB = registerBlock("pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.PINK_PASTEL_STAIRS, ItemGroups.COLORED_BLOCKS);
    public static final Block WHITE_PASTEL_SLAB = registerBlock("white_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_WHITE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block LIGHT_GRAY_PASTEL_SLAB = registerBlock("light_gray_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_LIGHT_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.WHITE_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block GRAY_PASTEL_SLAB = registerBlock("gray_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_GRAY).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.LIGHT_GRAY_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block BLACK_PASTEL_SLAB = registerBlock("black_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_BLACK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.GRAY_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block BROWN_PASTEL_SLAB = registerBlock("brown_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_BROWN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.BLACK_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block RED_PASTEL_SLAB = registerBlock("red_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_RED).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.BROWN_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block ORANGE_PASTEL_SLAB = registerBlock("orange_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_ORANGE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.RED_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block YELLOW_PASTEL_SLAB = registerBlock("yellow_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.ORANGE_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block LIME_PASTEL_SLAB = registerBlock("lime_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_LIME).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.YELLOW_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block GREEN_PASTEL_SLAB = registerBlock("green_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_GREEN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.LIME_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block CYAN_PASTEL_SLAB = registerBlock("cyan_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_CYAN).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.GREEN_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block LIGHT_BLUE_PASTEL_SLAB = registerBlock("light_blue_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_LIGHT_BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.CYAN_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block BLUE_PASTEL_SLAB = registerBlock("blue_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_BLUE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.LIGHT_BLUE_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block PURPLE_PASTEL_SLAB = registerBlock("purple_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_PURPLE).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.BLUE_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block MAGENTA_PASTEL_SLAB = registerBlock("magenta_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_MAGENTA).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.PURPLE_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
    public static final Block PINK_PASTEL_SLAB = registerBlock("pink_pastel_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.TERRACOTTA_PINK).instrument(Instrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, HibiscusBlocks.MAGENTA_PASTEL_SLAB, ItemGroups.COLORED_BLOCKS);
