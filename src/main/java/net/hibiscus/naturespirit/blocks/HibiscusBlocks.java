...
public class HibiscusBlocks {
   public static final Block TALL_SCORCHED_GRASS = registerPlantBlock(
           "tall_scorched_grass",
           new TallLargeDesertFernBlock(FabricBlockSettings.create()
   ...
   public static final Block SCORCHED_GRASS = registerPlantBlock(
           "scorched_grass",
           new LargeDesertFernBlock(FabricBlockSettings.create()
                   .mapColor(MapColor.LICHEN_GREEN)
                   .noCollision()
                   .breakInstantly()
                   .sounds(BlockSoundGroup.GRASS)
   ...
   public static final Block LARGE_FLAXEN_FERN = registerPlantBlock(
           "large_flaxen_fern",
           new TallPlantBlock(FabricBlockSettings.create()
   ...
   public static final Block FLAXEN_FERN = registerPlantBlock(
           "flaxen_fern",
           new HibiscusFernBlock(FabricBlockSettings.create()
                   .mapColor(MapColor.GOLD)
                   .noCollision()
                   .breakInstantly()
                   .sounds(BlockSoundGroup.GRASS)
   ...
   public static final Block SHIITAKE_MUSHROOM = registerPlantBlock(
           "shiitake_mushroom",
           new ShiitakeMushroomPlantBlock(AbstractBlock.Settings.create()
   ...
   public static final Block SHIITAKE_MUSHROOM_BLOCK = registerBlock("shiitake_mushroom_block", new MushroomBlock(FabricBlockSettings.create().mapColor(MapColor.DIRT_BROWN).instrument(Instrument.BASS).strength(0.2F).sounds(BlockSoundGroup.WOOD).burnable()), HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP, Blocks.RED_MUSHROOM_BLOCK, ItemGroups.NATURAL);
   ...
   public static final Block BLUEBELL = registerPlantBlock("bluebell", new LargeFlowerBlock(StatusEffects.HASTE,
           7,
           FabricBlockSettings.create().mapColor(MapColor.DARK_GREEN).noCollision().breakInstantly().sounds(
                   BlockSoundGroup.GRASS).offset(AbstractBlock.OffsetType.XZ).pistonBehavior(PistonBehavior.DESTROY)
   ...
   public static final Block TIGER_LILY = registerPlantBlock("tiger_lily",
           new LargeFlowerBlock(StatusEffects.FIRE_RESISTANCE,
                   7,
   ...
   public static final WoodType REDWOOD_WOOD_TYPE = WoodTypeAccessor.registerNew(new WoodType(
           "redwood",
   ...
   public static final WoodType SUGI_WOOD_TYPE = WoodTypeAccessor.registerNew(new WoodType(
           "sugi",
           SUGI_BLOCK_SET_TYPE
   ));
   ...
   public static final BlockSetType WISTERIA_BLOCK_SET_TYPE = BlockSetTypeAccessor.registerNew(new BlockSetType(
           "wisteria"));
   public static final WoodType WISTERIA_WOOD_TYPE = WoodTypeAccessor.registerNew(new WoodType(
           "wisteria",
   ...
   public static final WoodType WILLOW_WOOD_TYPE = WoodTypeAccessor.registerNew(new WoodType(
           "willow",
   ...
   public static final WoodType ASPEN_WOOD_TYPE = WoodTypeAccessor.registerNew(new WoodType(
           "aspen",
   ...
   public static final WoodType MAPLE_WOOD_TYPE = WoodTypeAccessor.registerNew(new WoodType(
           "maple",
           ASPEN_BLOCK_SET_TYPE
   ));
   public static final BlockSetType CYPRESS_BLOCK_SET_TYPE = BlockSetTypeAccessor.registerNew(new BlockSetType("cypress"));
   public static final WoodType CYPRESS_WOOD_TYPE = WoodTypeAccessor.registerNew(new WoodType(
           "cypress",
   ...
   public static final WoodType OLIVE_WOOD_TYPE = WoodTypeAccessor.registerNew(new WoodType(
           "olive",
   ...
   public static final WoodType JOSHUA_WOOD_TYPE = WoodTypeAccessor.registerNew(new WoodType(
           "joshua",
   ...
   public static final Item DESERT_TURNIP = registerItem(
           "desert_turnip",
   ...
   public static final Item SUGI_BOAT = registerItem(
           "sugi_boat",
   ...
   public static final Item SUGI_CHEST_BOAT = registerItem(
           "sugi_chest_boat",
   ...
   public static final Item WISTERIA_BOAT = registerItem(
           "wisteria_boat",
   ...
   public static final Item WISTERIA_CHEST_BOAT = registerItem(
           "wisteria_chest_boat",
   ...
   public static final Item JOSHUA_BOAT = registerItem(
           "joshua_boat",
   ...
   public static final Item JOSHUA_CHEST_BOAT = registerItem(
           "joshua_chest_boat",
   ...
   public static final Block GRAY_CHALK = registerBlock("gray_chalk",
           new Block(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.LIGHT_GRAY_CHALK,
           ItemGroups.COLORED_BLOCKS
   );
   ...
   public static final Block BLUE_CHALK = registerBlock("blue_chalk",
           new Block(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.LIGHT_BLUE_CHALK,
           ItemGroups.COLORED_BLOCKS
   );
   ...
   public static final Block LIGHT_GRAY_CHALK_STAIRS = registerBlock("light_gray_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.WHITE_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block GRAY_CHALK_STAIRS = registerBlock("gray_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.LIGHT_GRAY_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block BLACK_CHALK_STAIRS = registerBlock("black_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.GRAY_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block BROWN_CHALK_STAIRS = registerBlock("brown_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.BLACK_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block RED_CHALK_STAIRS = registerBlock("red_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.BROWN_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block ORANGE_CHALK_STAIRS = registerBlock("orange_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.RED_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block YELLOW_CHALK_STAIRS = registerBlock("yellow_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.ORANGE_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block LIME_CHALK_STAIRS = registerBlock("lime_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.YELLOW_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block GREEN_CHALK_STAIRS = registerBlock("green_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.LIME_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block CYAN_CHALK_STAIRS = registerBlock("cyan_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.GREEN_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block LIGHT_BLUE_CHALK_STAIRS = registerBlock("light_blue_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.CYAN_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block BLUE_CHALK_STAIRS = registerBlock("blue_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.LIGHT_BLUE_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block PURPLE_CHALK_STAIRS = registerBlock("purple_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.BLUE_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block MAGENTA_CHALK_STAIRS = registerBlock("magenta_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.PURPLE_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block PINK_CHALK_STAIRS = registerBlock("pink_chalk_stairs",
           ...
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.MAGENTA_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block WHITE_CHALK_SLAB = registerBlock("white_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.PINK_CHALK_STAIRS,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block LIGHT_GRAY_CHALK_SLAB = registerBlock("light_gray_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.WHITE_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block GRAY_CHALK_SLAB = registerBlock("gray_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.LIGHT_GRAY_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block BLACK_CHALK_SLAB = registerBlock("black_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.GRAY_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block BROWN_CHALK_SLAB = registerBlock("brown_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.BLACK_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block RED_CHALK_SLAB = registerBlock("red_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.BROWN_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   ...
   public static final Block YELLOW_CHALK_SLAB = registerBlock("yellow_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.ORANGE_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block LIME_CHALK_SLAB = registerBlock("lime_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.YELLOW_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block GREEN_CHALK_SLAB = registerBlock("green_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.LIME_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block CYAN_CHALK_SLAB = registerBlock("cyan_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.GREEN_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block LIGHT_BLUE_CHALK_SLAB = registerBlock("light_blue_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.CYAN_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block BLUE_CHALK_SLAB = registerBlock("blue_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.LIGHT_BLUE_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block PURPLE_CHALK_SLAB = registerBlock("purple_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.BLUE_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block MAGENTA_CHALK_SLAB = registerBlock("magenta_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.PURPLE_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   public static final Block PINK_CHALK_SLAB = registerBlock("pink_chalk_slab",
           new SlabBlock(FabricBlockSettings.create()
                   ...
                   .strength(1.25F, 4.2F)),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           HibiscusBlocks.MAGENTA_CHALK_SLAB,
           ItemGroups.COLORED_BLOCKS
   );
   ...
   public static final Block[] RED_MAPLE_SAPLING = registerSapling(
           "red_maple",
           new RedMapleSaplingGenerator(),
           ASPEN_SAPLING[0]
   );
   public static final Block[] ORANGE_MAPLE_SAPLING = registerSapling(
           "orange_maple",
           new OrangeMapleSaplingGenerator(),
           RED_MAPLE_SAPLING[0]
   );
   public static final Block[] YELLOW_MAPLE_SAPLING = registerSapling(
           "yellow_maple",
           new YellowMapleSaplingGenerator(),
           ORANGE_MAPLE_SAPLING[0]
   );
   ...
   public static final Block[] JOSHUA_SAPLING = registerJoshuaSapling(
           "joshua",
   ...
   public static final Block RED_MAPLE_LEAVES = registerMapleLeafBlock(
           "red_maple",
           MapColor.DARK_RED,
           RED_MAPLE_LEAVES_PARTICLE,
           ASPEN_LEAVES
   );
   public static final Block ORANGE_MAPLE_LEAVES = registerMapleLeafBlock(
           "orange_maple",
           MapColor.ORANGE,
           ORANGE_MAPLE_LEAVES_PARTICLE,
           RED_MAPLE_LEAVES
   );
   public static final Block YELLOW_MAPLE_LEAVES = registerMapleLeafBlock(
           "yellow_maple",
           MapColor.PALE_YELLOW,
   ...
   public static Block registerMapleLeafBlock(String name, MapColor color, ParticleEffect particle, Block blockBefore) {
      Block Leaves = registerBlock(
              ...
              new MapleLeavesBlock(FabricBlockSettings.create()
                      ...
                      .blockVision(HibiscusBlocks::never)
                      .pistonBehavior(PistonBehavior.DESTROY)
                      .solidBlock(HibiscusBlocks::never), particle),
              HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP
      );
      BlockRenderLayerMap.INSTANCE.putBlock(Leaves, RenderLayer.getCutout());
      FlammableBlockRegistry.getDefaultInstance().add(Leaves, 5, 20);
