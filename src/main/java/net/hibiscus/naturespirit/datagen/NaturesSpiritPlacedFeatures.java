...
public class NaturesSpiritPlacedFeatures {
...
//   public static final RegistryKey <PlacedFeature> BANYAN_CHECKED = registerKey("banyan_checked");
   ...
   public static void bootstrap(Registerable <PlacedFeature> context) {
      ...
      registerKey(context,
              ...
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.LARGE_REDWOOD_TREE),
              List.of(PlacedFeatures.wouldSurvive(HibiscusWoods.REDWOOD.getSapling()))
      );
      registerKey(context,
              LARGE_FROSTY_REDWOOD_CHECKED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.LARGE_FROSTY_REDWOOD_TREE),
              List.of(PlacedFeatures.wouldSurvive(HibiscusWoods.REDWOOD.getSapling()))
      );
      registerKey(context, REDWOOD_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.REDWOOD_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.REDWOOD.getSapling()));
      registerKey(context, FROSTY_REDWOOD_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.FROSTY_REDWOOD_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.REDWOOD.getSapling()));
      registerKey(context, ASPEN_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.ASPEN_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.ASPEN.getSapling()));
      registerKey(context,
              ASPEN_BEES_CHECKED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.ASPEN_TREE_BEES),
              PlacedFeatures.wouldSurvive(HibiscusWoods.ASPEN.getSapling())
      );
      registerKey(context,
              RED_MAPLE_CHECKED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.RED_MAPLE_TREE),
              PlacedFeatures.wouldSurvive(HibiscusWoods.MAPLE.getRedSapling())
      );
      registerKey(context,
              ORANGE_MAPLE_CHECKED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.ORANGE_MAPLE_TREE),
              PlacedFeatures.wouldSurvive(HibiscusWoods.MAPLE.getOrangeSapling())
      );
      registerKey(context,
              YELLOW_MAPLE_CHECKED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.YELLOW_MAPLE_TREE),
              PlacedFeatures.wouldSurvive(HibiscusWoods.MAPLE.getYellowSapling())
      );
      registerKey(context, CYPRESS_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.CYPRESS_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.CYPRESS.getSapling()));
      registerKey(context, JOSHUA_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.JOSHUA_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.JOSHUA.getSapling()));
      registerKey(context, ALLUAUDIA_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.ALLUAUDIA), PlacedFeatures.wouldSurvive(HibiscusWoods.JOSHUA.getSapling()));
      registerKey(context, GHAF_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.GHAF_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.GHAF.getSapling()));
      registerKey(context, PALO_VERDE_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.PALO_VERDE_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.PALO_VERDE.getSapling()));
      registerKey(context, CEDAR_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.CEDAR_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.CEDAR.getSapling()));
      registerKey(context, COCONUT_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.COCONUT_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.JOSHUA.getSapling()));
      registerKey(context, FIR_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.FIR_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.FIR.getSapling()));
      registerKey(context, LARCH_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.LARCH_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.LARCH.getSapling()));
      registerKey(context, WILLOW_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.WILLOW_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.WILLOW.getSapling()));
      registerKey(context, MAHOGANY_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.MAHOGANY_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.MAHOGANY.getSapling()));
      registerKey(context, LARGE_SUGI_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.LARGE_SUGI_SPAWN), PlacedFeatures.wouldSurvive(HibiscusWoods.SUGI.getSapling()));
      registerKey(context, SAXAUL_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.SAXAUL_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.SAXAUL.getSapling()));
      registerKey(context,
              WHITE_WISTERIA_CHECKED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.WHITE_WISTERIA_TREE),
              PlacedFeatures.wouldSurvive(HibiscusWoods.WISTERIA.getWhiteSapling())
      );
      registerKey(context,
              BLUE_WISTERIA_CHECKED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.BLUE_WISTERIA_TREE),
              PlacedFeatures.wouldSurvive(HibiscusWoods.WISTERIA.getBlueSapling())
      );
      registerKey(context,
              PINK_WISTERIA_CHECKED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.PINK_WISTERIA_TREE),
              PlacedFeatures.wouldSurvive(HibiscusWoods.WISTERIA.getPinkSapling())
      );
      registerKey(context,
              PURPLE_WISTERIA_CHECKED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.PURPLE_WISTERIA_TREE),
              PlacedFeatures.wouldSurvive(HibiscusWoods.WISTERIA.getPurpleSapling())
      );
      registerKey(context, SUGI_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.SUGI_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.SUGI.getSapling()));
//      registerKey(context, BANYAN_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.BANYAN_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.BANYAN.getSapling()));
      registerKey(context, OLIVE_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.OLIVE_TREE), PlacedFeatures.wouldSurvive(HibiscusWoods.OLIVE.getSapling()));

      registerKey(context, OAK_BUSH_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.OAK_BUSH), BlockFilterPlacementModifier.of(BlockPredicate.anyOf(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.getDefaultState(),
              BlockPos.ORIGIN), BlockPredicate.matchingBlockTag(BlockPos.ORIGIN.down(), HibiscusTags.Blocks.KAOLIN))));
      registerKey(context, SPRUCE_BUSH_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.SPRUCE_BUSH), PlacedFeatures.wouldSurvive(Blocks.SPRUCE_SAPLING));

      registerKey(context,
              FLOWER_WISTERIA_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.FLOWER_WISTERIA_FOREST),
      ...
      registerKey(context,
              FLOWER_SUGI_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.FLOWER_SUGI_FOREST),
      ...
      registerKey(context,
              FLOWER_RIVER_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.FLOWER_ERODED_RIVER),
      ...
      registerKey(context,
              ...
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.FLOWER_GOLDEN_WILDS),
              CountPlacementModifier.of(3),
      ...
      registerKey(context,
              ...
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.FLOWER_CYPRESS_FIELDS),
              CountPlacementModifier.of(3),
      ...
      registerKey(context,
              ...
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.PATCH_SCORCHED_GRASS),
              CountPlacementModifier.of(4),
              RarityFilterPlacementModifier.of(2),
              SquarePlacementModifier.of(),
              PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP,
      ...
      registerKey(context,
              ...
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.PATCH_TALL_SCORCHED_GRASS),
              CountPlacementModifier.of(3),
              RarityFilterPlacementModifier.of(2),
              SquarePlacementModifier.of(),
              PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP,
      ...
      registerKey(context,
              ...
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.FLOWER_STRATIFIED_DESERT),
              CountPlacementModifier.of(3),
              RarityFilterPlacementModifier.of(15),
              SquarePlacementModifier.of(),
              PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP,
      ...
      registerKey(context,
              WISTERIA_WATER,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.WISTERIA_DELTA),
      ...
      registerKey(context, SWAMP_WATER, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.SWAMP_DELTA), CountMultilayerPlacementModifier.of(10), BiomePlacementModifier.of());
      registerKey(context, MARSH_WATER, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.MARSH_DELTA), CountMultilayerPlacementModifier.of(20), BiomePlacementModifier.of());
      registerKey(context, RIVER_WATER, configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.RIVER_DELTA), CountMultilayerPlacementModifier.of(20), BiomePlacementModifier.of());

      registerKey(context,
              LARGE_REDWOOD_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.LARGE_REDWOOD_TREE_SPAWN),
              CountPlacementModifier.of(3),
              SquarePlacementModifier.of(),
              TREE_THRESHOLD,
      ...
      registerKey(context,
              REDWOOD_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.REDWOOD_TREE_SPAWN),
      ...
      registerKey(context,
              ...
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.LARGE_FROSTY_REDWOOD_TREE_SPAWN),
              CountPlacementModifier.of(3),
              SquarePlacementModifier.of(),
              TREE_THRESHOLD,
              PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP,
      ...
      registerKey(context,
              ...
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.FROSTY_REDWOOD_TREE_SPAWN),
              CountPlacementModifier.of(7),
              SquarePlacementModifier.of(),
              TREE_THRESHOLD,
              PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP,
      ...
      registerKey(context,
              ASPEN_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.ASPEN_TREE_SPAWN),
              CountPlacementModifier.of(4),
              SquarePlacementModifier.of(),
              TREE_THRESHOLD,
              PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP,
      ...
      registerKey(context,
              ...
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.CYPRESS_TREE_SPAWN),
      ...
      registerKey(context,
              CEDAR_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.CEDAR_TREE_SPAWN),
              CountPlacementModifier.of(3),
      ...
      registerKey(context,
              SPARSE_OLIVE_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.OLIVE_TREE_SPAWN),
              CountPlacementModifier.of(3),
              RarityFilterPlacementModifier.of(50),
              SquarePlacementModifier.of(),
              TREE_THRESHOLD,
      ...
      registerKey(context,
              MAPLE2_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.MAPLE_SPAWN),
              CountPlacementModifier.of(7),
              SquarePlacementModifier.of(),
              TREE_THRESHOLD,
              PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP,
      ...
      registerKey(context,
              FIR_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.FIR_TREE_SPAWN),
      ...
      registerKey(context,
              WILLOW_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.WILLOW_TREE_SPAWN),
      ...
      registerKey(context,
              SPRUCE_BUSH_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.SPRUCE_BUSH_SPAWN),
              CountPlacementModifier.of(4),
              SquarePlacementModifier.of(),
              TREE_THRESHOLD,
              PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP,
      ...
      registerKey(context,
              WISTERIA_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.WISTERIA_SPAWN),
      ...
      registerKey(context,
              SUGI_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.SUGI_SPAWN),
      ...
      registerKey(context,
              MAHOGANY_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.MAHOGANY_TREE_SPAWN),
              CountPlacementModifier.of(2),
              SquarePlacementModifier.of(),
      ...
      registerKey(context,
              GHAF_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.GHAF_TREE_SPAWN),
      ...
      registerKey(context,
              PALO_VERDE_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.PALO_VERDE_TREE_SPAWN),
      ...
      registerKey(context,
              SAXAUL_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.SAXAUL_TREE_SPAWN),
      ...
      registerKey(context,
              JOSHUA_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.JOSHUA_TREE_SPAWN),
              CountPlacementModifier.of(20),
              RarityFilterPlacementModifier.of(80),
              SquarePlacementModifier.of(),
              TREE_THRESHOLD,
      ...
      registerKey(context,
              ALLUAUDIA_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.ALLUAUDIA_SPAWN),
              CountPlacementModifier.of(10),
              RarityFilterPlacementModifier.of(80),
              SquarePlacementModifier.of(),
              TREE_THRESHOLD,
      ...
      registerKey(context,
              COCONUT_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.COCONUT_TREE_SPAWN),
              CountPlacementModifier.of(3),
      ...
      registerKey(context,
              OAK_BUSH_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.OAK_BUSH_SPAWN),
              CountPlacementModifier.of(1),
              SquarePlacementModifier.of(),
              TREE_THRESHOLD,
              PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP,
      ...
      registerKey(context,
              ...
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.FANCY_OAK_TREE_SPAWN),
              CountPlacementModifier.of(1),
              SquarePlacementModifier.of(),
              TREE_THRESHOLD,
              PlacedFeatures.OCEAN_FLOOR_HEIGHTMAP,
      ...
      registerKey(context,
              CATTAILS,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.CATTAILS),
              RarityFilterPlacementModifier.of(1),
              SquarePlacementModifier.of(),
              PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP,
              BiomePlacementModifier.of()
      ...
      registerKey(context,
              LOTUS_PLANT_PLACED,
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.LOTUS_PLANT),
              RarityFilterPlacementModifier.of(15),
              SquarePlacementModifier.of(),
              PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP,
              BiomePlacementModifier.of()
      ...
      registerKey(context,
              ...
              configuredFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritConfiguredFeatures.ROOTED_DESERT_TURNIP),
