...
public class NSRecipeGenerator extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.KAOLIN).pattern("SS").pattern("SS").criterion("has_kaolin", conditionsFromItem(
                NSColoredBlocks.KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.WHITE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.WHITE_KAOLIN).pattern("SS").pattern("SS").criterion("has_white_kaolin", conditionsFromItem(
                NSColoredBlocks.WHITE_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.LIGHT_GRAY_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.LIGHT_GRAY_KAOLIN).pattern("SS").pattern("SS").criterion("has_light_gray_kaolin", conditionsFromItem(
                NSColoredBlocks.LIGHT_GRAY_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.GRAY_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.GRAY_KAOLIN).pattern("SS").pattern("SS").criterion("has_gray_kaolin", conditionsFromItem(
                NSColoredBlocks.GRAY_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.BLACK_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.BLACK_KAOLIN).pattern("SS").pattern("SS").criterion("has_black_kaolin", conditionsFromItem(
                NSColoredBlocks.BLACK_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.BROWN_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.BROWN_KAOLIN).pattern("SS").pattern("SS").criterion("has_brown_kaolin", conditionsFromItem(
                NSColoredBlocks.BROWN_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.RED_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.RED_KAOLIN).pattern("SS").pattern("SS").criterion("has_red_kaolin", conditionsFromItem(
                NSColoredBlocks.RED_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.ORANGE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.ORANGE_KAOLIN).pattern("SS").pattern("SS").criterion("has_orange_kaolin", conditionsFromItem(
                NSColoredBlocks.ORANGE_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.YELLOW_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.YELLOW_KAOLIN).pattern("SS").pattern("SS").criterion("has_yellow_kaolin", conditionsFromItem(
                NSColoredBlocks.YELLOW_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.LIME_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.LIME_KAOLIN).pattern("SS").pattern("SS").criterion("has_lime_kaolin", conditionsFromItem(
                NSColoredBlocks.LIME_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.GREEN_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.GREEN_KAOLIN).pattern("SS").pattern("SS").criterion("has_green_kaolin", conditionsFromItem(
                NSColoredBlocks.GREEN_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.CYAN_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.CYAN_KAOLIN).pattern("SS").pattern("SS").criterion("has_cyan_kaolin", conditionsFromItem(
                NSColoredBlocks.CYAN_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.LIGHT_BLUE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.LIGHT_BLUE_KAOLIN).pattern("SS").pattern("SS").criterion("has_light_blue_kaolin", conditionsFromItem(
                NSColoredBlocks.LIGHT_BLUE_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.BLUE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.BLUE_KAOLIN).pattern("SS").pattern("SS").criterion("has_blue_kaolin", conditionsFromItem(
                NSColoredBlocks.BLUE_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.PURPLE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.PURPLE_KAOLIN).pattern("SS").pattern("SS").criterion("has_purple_kaolin", conditionsFromItem(
                NSColoredBlocks.PURPLE_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.MAGENTA_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.MAGENTA_KAOLIN).pattern("SS").pattern("SS").criterion("has_magenta_kaolin", conditionsFromItem(
                NSColoredBlocks.MAGENTA_KAOLIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSColoredBlocks.PINK_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSColoredBlocks.PINK_KAOLIN).pattern("SS").pattern("SS").criterion("has_pink_kaolin", conditionsFromItem(
                NSColoredBlocks.PINK_KAOLIN)).offerTo(exporter);


//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.MAROON_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.MAROON_KAOLIN).pattern("SS").pattern("SS").criterion("has_maroon_kaolin", conditionsFromItem(NSDyeDepotCompatibility.MAROON_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.ROSE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.ROSE_KAOLIN).pattern("SS").pattern("SS").criterion("has_rose_kaolin", conditionsFromItem(NSDyeDepotCompatibility.ROSE_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.CORAL_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.CORAL_KAOLIN).pattern("SS").pattern("SS").criterion("has_coral_kaolin", conditionsFromItem(NSDyeDepotCompatibility.CORAL_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.GINGER_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.GINGER_KAOLIN).pattern("SS").pattern("SS").criterion("has_ginger_kaolin", conditionsFromItem(NSDyeDepotCompatibility.GINGER_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.TAN_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.TAN_KAOLIN).pattern("SS").pattern("SS").criterion("has_tan_kaolin", conditionsFromItem(NSDyeDepotCompatibility.TAN_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.BEIGE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.BEIGE_KAOLIN).pattern("SS").pattern("SS").criterion("has_beige_kaolin", conditionsFromItem(NSDyeDepotCompatibility.BEIGE_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.AMBER_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.AMBER_KAOLIN).pattern("SS").pattern("SS").criterion("has_amber_kaolin", conditionsFromItem(NSDyeDepotCompatibility.AMBER_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.OLIVE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.OLIVE_KAOLIN).pattern("SS").pattern("SS").criterion("has_olive_kaolin", conditionsFromItem(NSDyeDepotCompatibility.OLIVE_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.FOREST_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.FOREST_KAOLIN).pattern("SS").pattern("SS").criterion("has_forest_kaolin", conditionsFromItem(NSDyeDepotCompatibility.FOREST_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.VERDANT_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.VERDANT_KAOLIN).pattern("SS").pattern("SS").criterion("has_verdant_kaolin", conditionsFromItem(NSDyeDepotCompatibility.VERDANT_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.TEAL_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.TEAL_KAOLIN).pattern("SS").pattern("SS").criterion("has_teal_kaolin", conditionsFromItem(NSDyeDepotCompatibility.TEAL_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.MINT_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.MINT_KAOLIN).pattern("SS").pattern("SS").criterion("has_mint_kaolin", conditionsFromItem(NSDyeDepotCompatibility.MINT_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.AQUA_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.AQUA_KAOLIN).pattern("SS").pattern("SS").criterion("has_aqua_kaolin", conditionsFromItem(NSDyeDepotCompatibility.AQUA_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.SLATE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.SLATE_KAOLIN).pattern("SS").pattern("SS").criterion("has_slate_kaolin", conditionsFromItem(NSDyeDepotCompatibility.SLATE_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.NAVY_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.NAVY_KAOLIN).pattern("SS").pattern("SS").criterion("has_navy_kaolin", conditionsFromItem(NSDyeDepotCompatibility.NAVY_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, NSDyeDepotCompatibility.INDIGO_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), NSDyeDepotCompatibility.INDIGO_KAOLIN).pattern("SS").pattern("SS").criterion("has_indigo_kaolin", conditionsFromItem(NSDyeDepotCompatibility.INDIGO_KAOLIN)).offerTo(exporter);
//
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.fromTag(NSTags.Items.COCONUT_ITEMS), RecipeCategory.MISC, Items.CHARCOAL, 0.15F, 125).criterion("has_coconut", conditionsFromTag(
                NSTags.Items.COCONUT_ITEMS)).offerTo(exporter, new Identifier(MOD_ID, "charcoal_from_coconuts"));
