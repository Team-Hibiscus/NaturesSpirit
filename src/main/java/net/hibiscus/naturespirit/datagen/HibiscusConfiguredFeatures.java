...
public class HibiscusConfiguredFeatures {
   ...
   public static final RegistryKey <ConfiguredFeature <?, ?>> PUMPKIN_PATCH_FEATURE = registerKey(
   ...
   public static final RegistryKey <ConfiguredFeature <?, ?>> HUGE_SHIITAKE_MUSHROOM = registerKey(
   ...
   public static final RegistryKey <ConfiguredFeature <?, ?>> PATCH_TALL_SCORCHED_GRASS = registerKey(
           "patch_tall_scorched_grass");
   public static final RegistryKey <ConfiguredFeature <?, ?>> FLOWER_BLOOMING_DUNES = registerKey(
           "flower_blooming_dunes");
   public static final RegistryKey <ConfiguredFeature <?, ?>> FLOWER_STRATIFIED_DESERT = registerKey(
   ...
   public static void bootstrap(Registerable <ConfiguredFeature <?, ?>> context) {
      ...
      register(context,
              REDWOOD_TREE,
              Feature.TREE,
              new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.REDWOOD[2]),
      ...
      register(context,
              ...
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(
      ...
      register(context,
              ASPEN_TREE,
              Feature.TREE,
              new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.ASPEN[2]),
      ...
      register(context,
              RED_MAPLE_TREE,
              Feature.TREE,
              new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.MAPLE[2]),
                      ...
                      new MapleFoliagePlacer(ConstantIntProvider.create(4),
               ...
               .decorators(ImmutableList.of(new MapleGroundTreeDecorator(
                       SimpleBlockStateProvider.of(Blocks.PODZOL),
                       SimpleBlockStateProvider.of(Blocks.COARSE_DIRT)
               )))
               .build()
      );
      register(context, ORANGE_MAPLE_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(
       ...
       .build());
      register(context, YELLOW_MAPLE_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(
              HibiscusWoods.MAPLE[2]),
              new MapleTrunkPlacer(9,
                      2,
                      0,
      ...
      register(context,
              CYPRESS_TREE,
              Feature.TREE,
              new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.CYPRESS[2]),
      ...
      register(context,
              FIR_TREE,
              Feature.TREE,
              new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.FIR[2]),
      ...
      register(context,
              WILLOW_TREE,
              Feature.TREE,
              new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.WILLOW[2]),
                      ...
                      new RandomizedIntBlockStateProvider(BlockStateProvider.of(HibiscusWoods.WILLOW_VINES.getDefaultState()),
                              WisteriaVine.AGE,
      ...
      register(context, WHITE_WISTERIA_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(
              ...
              new RandomizedIntBlockStateProvider(BlockStateProvider.of(HibiscusWoods.WHITE_WISTERIA_VINES.getDefaultState()),
                      WisteriaVine.AGE,
      ...
      register(context, PINK_WISTERIA_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(
              ...
              new RandomizedIntBlockStateProvider(BlockStateProvider.of(HibiscusWoods.PINK_WISTERIA_VINES.getDefaultState()),
                      WisteriaVine.AGE,
                      UniformIntProvider.create(22, 25)
              ),
              2
      ...
      register(context, BLUE_WISTERIA_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(
              ...
              new RandomizedIntBlockStateProvider(BlockStateProvider.of(HibiscusWoods.BLUE_WISTERIA_VINES.getDefaultState()),
                      WisteriaVine.AGE,
                      UniformIntProvider.create(22, 25)
              ),
              2
      ...
      register(context, PURPLE_WISTERIA_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(
              ...
              new RandomizedIntBlockStateProvider(BlockStateProvider.of(HibiscusWoods.PURPLE_WISTERIA_VINES.getDefaultState()),
                      WisteriaVine.AGE,
                      UniformIntProvider.create(22, 25)
              ),
              2
      ...
      register(context,
              SUGI_TREE,
              Feature.TREE,
              new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.SUGI[2]),
      ...
      register(context,
              OLIVE_TREE,
              Feature.TREE,
              new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.OLIVE[2]),
      ...
      register(
              ...
              new HugeMushroomFeatureConfig(
                      BlockStateProvider.of(HibiscusBlocksAndItems.SHIITAKE_MUSHROOM_BLOCK.getDefaultState()
                                                                                          .with(
                                                                                                  MushroomBlock.UP,
                                                                                                  true
                                                                                          )
      ...
      register(context,
              ...
              new RandomPatchFeatureConfig(32,
                      7,
                      3,
                      PlacedFeatures.createEntry(
                              Feature.SIMPLE_BLOCK,
                              new SimpleBlockFeatureConfig(BlockStateProvider.of(HibiscusBlocksAndItems.SCORCHED_GRASS))
                      )
              )
      );
      register(context,
      ...
      register(context,
              ...
              new RandomPatchFeatureConfig(90, 6, 2, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK,
                      ...
                      BlockPredicate.allOf(BlockPredicate.wouldSurvive(HibiscusBlocksAndItems.CATTAIL.getDefaultState(),
                                      BlockPos.ORIGIN
                              ),
      ...
      register(context,
              ...
              new RandomPatchFeatureConfig(20,
                      6,
                      2,
                      PlacedFeatures.createEntry(LOTUS_PLANT_FEATURE, FeatureConfig.DEFAULT)
              )
      );
      ...
      register(context,
              ...
              new TurnipRootFeatureConfig(PlacedFeatures.createEntry(Feature.NO_BONEMEAL_FLOWER,
                      new RandomPatchFeatureConfig(30, 3, 2, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK,
                              new SimpleBlockFeatureConfig(BlockStateProvider.of(HibiscusBlocksAndItems.DESERT_TURNIP_STEM.getDefaultState()
                                                                                                                          .with(
