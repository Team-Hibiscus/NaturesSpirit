...
//       registerPaperLantern(HibiscusMintCompatibility.MAROON_PAPER_LANTERN, blockStateModelGenerator);
//               registerPaperLantern(HibiscusMintCompatibility.PEACH_PAPER_LANTERN, blockStateModelGenerator);
//       registerPaperLantern(HibiscusMintCompatibility.VERMILION_PAPER_LANTERN, blockStateModelGenerator);
//               registerPaperLantern(HibiscusMintCompatibility.AMBER_PAPER_LANTERN, blockStateModelGenerator);
//       registerPaperLantern(HibiscusMintCompatibility.BANANA_PAPER_LANTERN, blockStateModelGenerator);
//               registerPaperLantern(HibiscusMintCompatibility.MOLD_PAPER_LANTERN, blockStateModelGenerator);
//       registerPaperLantern(HibiscusMintCompatibility.ARTICHOKE_PAPER_LANTERN, blockStateModelGenerator);
//               registerPaperLantern(HibiscusMintCompatibility.SAGE_PAPER_LANTERN, blockStateModelGenerator);
//       registerPaperLantern(HibiscusMintCompatibility.SHAMROCK_PAPER_LANTERN, blockStateModelGenerator);
//               registerPaperLantern(HibiscusMintCompatibility.SAP_PAPER_LANTERN, blockStateModelGenerator);
//       registerPaperLantern(HibiscusMintCompatibility.MINT_PAPER_LANTERN, blockStateModelGenerator);
//               registerPaperLantern(HibiscusMintCompatibility.CERULEAN_PAPER_LANTERN, blockStateModelGenerator);
//       registerPaperLantern(HibiscusMintCompatibility.NAVY_PAPER_LANTERN, blockStateModelGenerator);
//               registerPaperLantern(HibiscusMintCompatibility.PERIWINKLE_PAPER_LANTERN, blockStateModelGenerator);
//       registerPaperLantern(HibiscusMintCompatibility.INDIGO_PAPER_LANTERN, blockStateModelGenerator);
//               registerPaperLantern(HibiscusMintCompatibility.GRAPE_PAPER_LANTERN, blockStateModelGenerator);
//       registerPaperLantern(HibiscusMintCompatibility.FUCHSIA_PAPER_LANTERN, blockStateModelGenerator);
//               registerPaperLantern(HibiscusMintCompatibility.VELVET_PAPER_LANTERN, blockStateModelGenerator);
//       registerPaperLantern(HibiscusMintCompatibility.MAUVE_PAPER_LANTERN, blockStateModelGenerator);
//
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.MAROON_KAOLIN, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.PEACH_KAOLIN, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.VERMILION_KAOLIN, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.AMBER_KAOLIN, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.BANANA_KAOLIN, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.MOLD_KAOLIN, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.ARTICHOKE_KAOLIN, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.SAGE_KAOLIN, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.SHAMROCK_KAOLIN, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.SAP_KAOLIN, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.MINT_KAOLIN, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.CERULEAN_KAOLIN, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.NAVY_KAOLIN, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.PERIWINKLE_KAOLIN, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.INDIGO_KAOLIN, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.GRAPE_KAOLIN, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.FUCHSIA_KAOLIN, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.VELVET_KAOLIN, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.MAUVE_KAOLIN, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.ACORN_KAOLIN, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.MAROON_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.PEACH_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.VERMILION_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.AMBER_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.BANANA_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.MOLD_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.ARTICHOKE_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.SAGE_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.SHAMROCK_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.SAP_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.MINT_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.CERULEAN_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.NAVY_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.PERIWINKLE_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.INDIGO_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.GRAPE_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.FUCHSIA_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.VELVET_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.MAUVE_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.ACORN_KAOLIN_BRICKS, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.MAROON_CHALK, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.PEACH_CHALK, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.VERMILION_CHALK, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.AMBER_CHALK, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.BANANA_CHALK, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.MOLD_CHALK, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.ARTICHOKE_CHALK, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.SAGE_CHALK, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.SHAMROCK_CHALK, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.SAP_CHALK, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.MINT_CHALK, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.CERULEAN_CHALK, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.NAVY_CHALK, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.PERIWINKLE_CHALK, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.INDIGO_CHALK, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.GRAPE_CHALK, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.FUCHSIA_CHALK, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.VELVET_CHALK, TexturedModel.CUBE_ALL);
//               blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.MAUVE_CHALK, TexturedModel.CUBE_ALL);
//       blockStateModelGenerator.registerSingleton(HibiscusMintCompatibility.ACORN_CHALK, TexturedModel.CUBE_ALL);
//
//               createStairs(HibiscusMintCompatibility.MAROON_KAOLIN, HibiscusMintCompatibility.MAROON_KAOLIN_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.PEACH_KAOLIN, HibiscusMintCompatibility.PEACH_KAOLIN_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.VERMILION_KAOLIN, HibiscusMintCompatibility.VERMILION_KAOLIN_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.AMBER_KAOLIN, HibiscusMintCompatibility.AMBER_KAOLIN_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.BANANA_KAOLIN, HibiscusMintCompatibility.BANANA_KAOLIN_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.MOLD_KAOLIN, HibiscusMintCompatibility.MOLD_KAOLIN_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.ARTICHOKE_KAOLIN, HibiscusMintCompatibility.ARTICHOKE_KAOLIN_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.SAGE_KAOLIN, HibiscusMintCompatibility.SAGE_KAOLIN_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.SHAMROCK_KAOLIN, HibiscusMintCompatibility.SHAMROCK_KAOLIN_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.SAP_KAOLIN, HibiscusMintCompatibility.SAP_KAOLIN_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.MINT_KAOLIN, HibiscusMintCompatibility.MINT_KAOLIN_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.CERULEAN_KAOLIN, HibiscusMintCompatibility.CERULEAN_KAOLIN_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.NAVY_KAOLIN, HibiscusMintCompatibility.NAVY_KAOLIN_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.PERIWINKLE_KAOLIN, HibiscusMintCompatibility.PERIWINKLE_KAOLIN_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.INDIGO_KAOLIN, HibiscusMintCompatibility.INDIGO_KAOLIN_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.GRAPE_KAOLIN, HibiscusMintCompatibility.GRAPE_KAOLIN_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.FUCHSIA_KAOLIN, HibiscusMintCompatibility.FUCHSIA_KAOLIN_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.VELVET_KAOLIN, HibiscusMintCompatibility.VELVET_KAOLIN_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.MAUVE_KAOLIN, HibiscusMintCompatibility.MAUVE_KAOLIN_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.ACORN_KAOLIN, HibiscusMintCompatibility.ACORN_KAOLIN_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.MAROON_KAOLIN_BRICKS, HibiscusMintCompatibility.MAROON_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.PEACH_KAOLIN_BRICKS, HibiscusMintCompatibility.PEACH_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.VERMILION_KAOLIN_BRICKS, HibiscusMintCompatibility.VERMILION_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.AMBER_KAOLIN_BRICKS, HibiscusMintCompatibility.AMBER_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.BANANA_KAOLIN_BRICKS, HibiscusMintCompatibility.BANANA_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.MOLD_KAOLIN_BRICKS, HibiscusMintCompatibility.MOLD_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.ARTICHOKE_KAOLIN_BRICKS, HibiscusMintCompatibility.ARTICHOKE_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.SAGE_KAOLIN_BRICKS, HibiscusMintCompatibility.SAGE_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.SHAMROCK_KAOLIN_BRICKS, HibiscusMintCompatibility.SHAMROCK_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.SAP_KAOLIN_BRICKS, HibiscusMintCompatibility.SAP_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.MINT_KAOLIN_BRICKS, HibiscusMintCompatibility.MINT_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.CERULEAN_KAOLIN_BRICKS, HibiscusMintCompatibility.CERULEAN_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.NAVY_KAOLIN_BRICKS, HibiscusMintCompatibility.NAVY_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.PERIWINKLE_KAOLIN_BRICKS, HibiscusMintCompatibility.PERIWINKLE_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.INDIGO_KAOLIN_BRICKS, HibiscusMintCompatibility.INDIGO_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.GRAPE_KAOLIN_BRICKS, HibiscusMintCompatibility.GRAPE_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.FUCHSIA_KAOLIN_BRICKS, HibiscusMintCompatibility.FUCHSIA_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.VELVET_KAOLIN_BRICKS, HibiscusMintCompatibility.VELVET_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.MAUVE_KAOLIN_BRICKS, HibiscusMintCompatibility.MAUVE_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.ACORN_KAOLIN_BRICKS, HibiscusMintCompatibility.ACORN_KAOLIN_BRICK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.MAROON_CHALK, HibiscusMintCompatibility.MAROON_CHALK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.PEACH_CHALK, HibiscusMintCompatibility.PEACH_CHALK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.VERMILION_CHALK, HibiscusMintCompatibility.VERMILION_CHALK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.AMBER_CHALK, HibiscusMintCompatibility.AMBER_CHALK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.BANANA_CHALK, HibiscusMintCompatibility.BANANA_CHALK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.MOLD_CHALK, HibiscusMintCompatibility.MOLD_CHALK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.ARTICHOKE_CHALK, HibiscusMintCompatibility.ARTICHOKE_CHALK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.SAGE_CHALK, HibiscusMintCompatibility.SAGE_CHALK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.SHAMROCK_CHALK, HibiscusMintCompatibility.SHAMROCK_CHALK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.SAP_CHALK, HibiscusMintCompatibility.SAP_CHALK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.MINT_CHALK, HibiscusMintCompatibility.MINT_CHALK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.CERULEAN_CHALK, HibiscusMintCompatibility.CERULEAN_CHALK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.NAVY_CHALK, HibiscusMintCompatibility.NAVY_CHALK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.PERIWINKLE_CHALK, HibiscusMintCompatibility.PERIWINKLE_CHALK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.INDIGO_CHALK, HibiscusMintCompatibility.INDIGO_CHALK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.GRAPE_CHALK, HibiscusMintCompatibility.GRAPE_CHALK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.FUCHSIA_CHALK, HibiscusMintCompatibility.FUCHSIA_CHALK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.VELVET_CHALK, HibiscusMintCompatibility.VELVET_CHALK_STAIRS, blockStateModelGenerator);
//               createStairs(HibiscusMintCompatibility.MAUVE_CHALK, HibiscusMintCompatibility.MAUVE_CHALK_STAIRS, blockStateModelGenerator);
//       createStairs(HibiscusMintCompatibility.ACORN_CHALK, HibiscusMintCompatibility.ACORN_CHALK_STAIRS, blockStateModelGenerator);
//
//               createSlab(HibiscusMintCompatibility.MAROON_KAOLIN, HibiscusMintCompatibility.MAROON_CHALK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.PEACH_KAOLIN, HibiscusMintCompatibility.PEACH_CHALK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.VERMILION_KAOLIN, HibiscusMintCompatibility.VERMILION_CHALK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.AMBER_KAOLIN, HibiscusMintCompatibility.AMBER_CHALK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.BANANA_KAOLIN, HibiscusMintCompatibility.BANANA_CHALK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.MOLD_KAOLIN, HibiscusMintCompatibility.MOLD_CHALK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.ARTICHOKE_KAOLIN, HibiscusMintCompatibility.ARTICHOKE_CHALK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.SAGE_KAOLIN, HibiscusMintCompatibility.SAGE_CHALK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.SHAMROCK_KAOLIN, HibiscusMintCompatibility.SHAMROCK_CHALK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.SAP_KAOLIN, HibiscusMintCompatibility.SAP_CHALK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.MINT_KAOLIN, HibiscusMintCompatibility.MINT_CHALK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.CERULEAN_KAOLIN, HibiscusMintCompatibility.CERULEAN_CHALK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.NAVY_KAOLIN, HibiscusMintCompatibility.NAVY_CHALK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.PERIWINKLE_KAOLIN, HibiscusMintCompatibility.PERIWINKLE_CHALK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.INDIGO_KAOLIN, HibiscusMintCompatibility.INDIGO_CHALK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.GRAPE_KAOLIN, HibiscusMintCompatibility.GRAPE_CHALK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.FUCHSIA_KAOLIN, HibiscusMintCompatibility.FUCHSIA_CHALK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.VELVET_KAOLIN, HibiscusMintCompatibility.VELVET_CHALK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.MAUVE_KAOLIN, HibiscusMintCompatibility.MAUVE_CHALK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.ACORN_KAOLIN, HibiscusMintCompatibility.ACORN_CHALK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.MAROON_KAOLIN_BRICKS, HibiscusMintCompatibility.MAROON_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.PEACH_KAOLIN_BRICKS, HibiscusMintCompatibility.PEACH_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.VERMILION_KAOLIN_BRICKS, HibiscusMintCompatibility.VERMILION_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.AMBER_KAOLIN_BRICKS, HibiscusMintCompatibility.AMBER_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.BANANA_KAOLIN_BRICKS, HibiscusMintCompatibility.BANANA_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.MOLD_KAOLIN_BRICKS, HibiscusMintCompatibility.MOLD_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.ARTICHOKE_KAOLIN_BRICKS, HibiscusMintCompatibility.ARTICHOKE_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.SAGE_KAOLIN_BRICKS, HibiscusMintCompatibility.SAGE_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.SHAMROCK_KAOLIN_BRICKS, HibiscusMintCompatibility.SHAMROCK_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.SAP_KAOLIN_BRICKS, HibiscusMintCompatibility.SAP_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.MINT_KAOLIN_BRICKS, HibiscusMintCompatibility.MINT_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.CERULEAN_KAOLIN_BRICKS, HibiscusMintCompatibility.CERULEAN_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.NAVY_KAOLIN_BRICKS, HibiscusMintCompatibility.NAVY_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.PERIWINKLE_KAOLIN_BRICKS, HibiscusMintCompatibility.PERIWINKLE_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.INDIGO_KAOLIN_BRICKS, HibiscusMintCompatibility.INDIGO_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.GRAPE_KAOLIN_BRICKS, HibiscusMintCompatibility.GRAPE_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.FUCHSIA_KAOLIN_BRICKS, HibiscusMintCompatibility.FUCHSIA_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.VELVET_KAOLIN_BRICKS, HibiscusMintCompatibility.VELVET_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.MAUVE_KAOLIN_BRICKS, HibiscusMintCompatibility.MAUVE_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.ACORN_KAOLIN_BRICKS, HibiscusMintCompatibility.ACORN_KAOLIN_BRICK_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.MAROON_CHALK, HibiscusMintCompatibility.MAROON_KAOLIN_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.PEACH_CHALK, HibiscusMintCompatibility.PEACH_KAOLIN_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.VERMILION_CHALK, HibiscusMintCompatibility.VERMILION_KAOLIN_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.AMBER_CHALK, HibiscusMintCompatibility.AMBER_KAOLIN_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.BANANA_CHALK, HibiscusMintCompatibility.BANANA_KAOLIN_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.MOLD_CHALK, HibiscusMintCompatibility.MOLD_KAOLIN_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.ARTICHOKE_CHALK, HibiscusMintCompatibility.ARTICHOKE_KAOLIN_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.SAGE_CHALK, HibiscusMintCompatibility.SAGE_KAOLIN_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.SHAMROCK_CHALK, HibiscusMintCompatibility.SHAMROCK_KAOLIN_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.SAP_CHALK, HibiscusMintCompatibility.SAP_KAOLIN_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.MINT_CHALK, HibiscusMintCompatibility.MINT_KAOLIN_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.CERULEAN_CHALK, HibiscusMintCompatibility.CERULEAN_KAOLIN_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.NAVY_CHALK, HibiscusMintCompatibility.NAVY_KAOLIN_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.PERIWINKLE_CHALK, HibiscusMintCompatibility.PERIWINKLE_KAOLIN_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.INDIGO_CHALK, HibiscusMintCompatibility.INDIGO_KAOLIN_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.GRAPE_CHALK, HibiscusMintCompatibility.GRAPE_KAOLIN_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.FUCHSIA_CHALK, HibiscusMintCompatibility.FUCHSIA_KAOLIN_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.VELVET_CHALK, HibiscusMintCompatibility.VELVET_KAOLIN_SLAB, blockStateModelGenerator);
//               createSlab(HibiscusMintCompatibility.MAUVE_CHALK, HibiscusMintCompatibility.MAUVE_KAOLIN_SLAB, blockStateModelGenerator);
//       createSlab(HibiscusMintCompatibility.ACORN_CHALK, HibiscusMintCompatibility.ACORN_KAOLIN_SLAB, blockStateModelGenerator);
