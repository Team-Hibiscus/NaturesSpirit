...
//   public static final RegistryKey <PlacedFeature> BANYAN_CHECKED = registerKey("banyan_checked");
   ...
   public static void bootstrap(Registerable <PlacedFeature> context) {
      ...
      registerKey(context, REDWOOD_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.REDWOOD_TREE), PlacedFeatures.wouldSurvive(NSWoods.REDWOOD.getSapling()));
      registerKey(context, FROSTY_REDWOOD_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.FROSTY_REDWOOD_TREE), PlacedFeatures.wouldSurvive(NSWoods.REDWOOD.getSapling()));
      ...
      registerKey(context, CYPRESS_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.CYPRESS_TREE), PlacedFeatures.wouldSurvive(NSWoods.CYPRESS.getSapling()));
      registerKey(context, JOSHUA_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.JOSHUA_TREE), PlacedFeatures.wouldSurvive(NSWoods.JOSHUA.getSapling()));
      registerKey(context, ALLUAUDIA_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.ALLUAUDIA), PlacedFeatures.wouldSurvive(NSWoods.JOSHUA.getSapling()));
      ...
      registerKey(context, PALO_VERDE_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.PALO_VERDE_TREE), PlacedFeatures.wouldSurvive(NSWoods.PALO_VERDE.getSapling()));
      ...
      registerKey(context, COCONUT_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.COCONUT_TREE), PlacedFeatures.wouldSurvive(NSWoods.JOSHUA.getSapling()));
      ...
      registerKey(context, WILLOW_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.WILLOW_TREE), PlacedFeatures.wouldSurvive(NSWoods.WILLOW.getSapling()));
      registerKey(context, MAHOGANY_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.MAHOGANY_TREE), PlacedFeatures.wouldSurvive(NSWoods.MAHOGANY.getSapling()));
      registerKey(context, LARGE_SUGI_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.LARGE_SUGI_SPAWN), PlacedFeatures.wouldSurvive(NSWoods.SUGI.getSapling()));
      registerKey(context, SAXAUL_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.SAXAUL_TREE), PlacedFeatures.wouldSurvive(NSWoods.SAXAUL.getSapling()));
      registerKey(context,
...
//      registerKey(context, BANYAN_CHECKED, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.BANYAN_TREE), PlacedFeatures.wouldSurvive(NSWoods.BANYAN.getSapling()));
      ...
      registerKey(context, SWAMP_WATER, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.SWAMP_DELTA), CountMultilayerPlacementModifier.of(10), BiomePlacementModifier.of());
      registerKey(context, MARSH_WATER, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.MARSH_DELTA), CountMultilayerPlacementModifier.of(20), BiomePlacementModifier.of());
      registerKey(context, RIVER_WATER, configuredFeatureRegistryEntryLookup.getOrThrow(NSConfiguredFeatures.RIVER_DELTA), CountMultilayerPlacementModifier.of(20), BiomePlacementModifier.of());
