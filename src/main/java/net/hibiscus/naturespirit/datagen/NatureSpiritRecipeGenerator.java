...
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.MAROON_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.MAROON_KAOLIN).pattern("SS").pattern("SS").criterion("has_maroon_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.MAROON_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.ROSE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.ROSE_KAOLIN).pattern("SS").pattern("SS").criterion("has_rose_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.ROSE_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.CORAL_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.CORAL_KAOLIN).pattern("SS").pattern("SS").criterion("has_coral_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.CORAL_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.GINGER_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.GINGER_KAOLIN).pattern("SS").pattern("SS").criterion("has_ginger_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.GINGER_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.TAN_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.TAN_KAOLIN).pattern("SS").pattern("SS").criterion("has_tan_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.TAN_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.BEIGE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.BEIGE_KAOLIN).pattern("SS").pattern("SS").criterion("has_beige_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.BEIGE_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.AMBER_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.AMBER_KAOLIN).pattern("SS").pattern("SS").criterion("has_amber_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.AMBER_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.OLIVE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.OLIVE_KAOLIN).pattern("SS").pattern("SS").criterion("has_olive_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.OLIVE_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.FOREST_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.FOREST_KAOLIN).pattern("SS").pattern("SS").criterion("has_forest_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.FOREST_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.VERDANT_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.VERDANT_KAOLIN).pattern("SS").pattern("SS").criterion("has_verdant_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.VERDANT_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.TEAL_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.TEAL_KAOLIN).pattern("SS").pattern("SS").criterion("has_teal_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.TEAL_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.MINT_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.MINT_KAOLIN).pattern("SS").pattern("SS").criterion("has_mint_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.MINT_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.AQUA_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.AQUA_KAOLIN).pattern("SS").pattern("SS").criterion("has_aqua_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.AQUA_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.SLATE_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.SLATE_KAOLIN).pattern("SS").pattern("SS").criterion("has_slate_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.SLATE_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.NAVY_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.NAVY_KAOLIN).pattern("SS").pattern("SS").criterion("has_navy_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.NAVY_KAOLIN)).offerTo(exporter);
//         ShapedRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, HibiscusDyeDepotCompatibility.INDIGO_KAOLIN_BRICKS, 4).input(Character.valueOf('S'), HibiscusDyeDepotCompatibility.INDIGO_KAOLIN).pattern("SS").pattern("SS").criterion("has_indigo_kaolin", conditionsFromItem(HibiscusDyeDepotCompatibility.INDIGO_KAOLIN)).offerTo(exporter);
//
