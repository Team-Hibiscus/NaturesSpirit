...
import static net.hibiscus.naturespirit.registration.HibiscusWorldGen.*;

public class NaturesSpiritConfiguredFeatures {
...
//   public static final RegistryKey <ConfiguredFeature <?, ?>> BANYAN_TREE_SPAWN = registerKey("banyan_tree_spawn");
   ...
   public static void bootstrap(Registerable <ConfiguredFeature <?, ?>> context) {
      ...
      ).ignoreVines().decorators(ImmutableList.of(new RedwoodBranchTreeDecorator(.1f, BlockStateProvider.of(HibiscusWoods.REDWOOD.getLeaves())), new PolyporeTreeDecorator(.3f,.2f, .05f, BlockStateProvider.of(HibiscusMiscBlocks.GRAY_POLYPORE_BLOCK), BlockStateProvider.of(HibiscusMiscBlocks.GRAY_POLYPORE)))).build());

      register(
              context,
              REDWOOD_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.REDWOOD_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.REDWOOD_CHECKED)
              )
      );
      ...
      register(context, LARGE_REDWOOD_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.REDWOOD.getLog()),
              ...
              new TwoLayersFeatureSize(2, 0, 2)
      ).decorators(ImmutableList.of(new AlterGroundTreeDecorator(BlockStateProvider.of(Blocks.PODZOL)), new RedwoodBranchTreeDecorator(.05f, BlockStateProvider.of(HibiscusWoods.REDWOOD.getLeaves())), new PolyporeTreeDecorator(.2f, .1f, .05f, BlockStateProvider.of(HibiscusMiscBlocks.GRAY_POLYPORE_BLOCK), BlockStateProvider.of(HibiscusMiscBlocks.GRAY_POLYPORE)))).build());

      register(
              context,
              LARGE_REDWOOD_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.LARGE_REDWOOD_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.LARGE_REDWOOD_CHECKED)
              )
      );

      register(context, FROSTY_REDWOOD_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.REDWOOD.getLog()),
              new StraightTrunkPlacer(20, 1, 10),
              BlockStateProvider.of(HibiscusWoods.REDWOOD.getFrostyLeaves()),
              new RedwoodFoliagePlacer(UniformIntProvider.create(1, 3), UniformIntProvider.create(1, 2), UniformIntProvider.create(22, 32)),
              new TwoLayersFeatureSize(2, 0, 2)
      ).ignoreVines().decorators(ImmutableList.of(new RedwoodBranchTreeDecorator(.1f, BlockStateProvider.of(HibiscusWoods.REDWOOD.getFrostyLeaves())), new SnowTreeDecorator())).build());

      register(
              context,
              FROSTY_REDWOOD_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.FROSTY_REDWOOD_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.FROSTY_REDWOOD_CHECKED)
              )
      );

      register(context, LARGE_FROSTY_REDWOOD_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.REDWOOD.getLog()),
              new GiantTrunkPlacer(25, 1, 6),
              BlockStateProvider.of(HibiscusWoods.REDWOOD.getFrostyLeaves()),
              new RedwoodFoliagePlacer(ConstantIntProvider.create(0), ConstantIntProvider.create(0), UniformIntProvider.create(27, 31)),
              new TwoLayersFeatureSize(2, 0, 2)
      ).decorators(ImmutableList.of(new AlterGroundTreeDecorator(BlockStateProvider.of(Blocks.PODZOL)), new RedwoodBranchTreeDecorator(.05f, BlockStateProvider.of(HibiscusWoods.REDWOOD.getFrostyLeaves())), new SnowTreeDecorator())).build());

      register(
              context,
              LARGE_FROSTY_REDWOOD_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.LARGE_FROSTY_REDWOOD_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.LARGE_FROSTY_REDWOOD_CHECKED)
              )
      );
      ...
      register(
              ...
              ASPEN_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.ASPEN_BEES_CHECKED), 0.01f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.ASPEN_CHECKED)
              )
      );
      ...
      register(context,
              ...
              new SimpleRandomFeatureConfig(RegistryEntryList.of(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.RED_MAPLE_CHECKED),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.ORANGE_MAPLE_CHECKED),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.YELLOW_MAPLE_CHECKED),
      ...
      register(context,
              FIR_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.FIR_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.FIR_CHECKED)
              )
      );
      ...
      register(context,
              MAHOGANY_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.MAHOGANY_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.MAHOGANY_CHECKED)
              )
      );
      ...
      register(context,
              LARCH_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.LARCH_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.LARCH_CHECKED)
              )
      );
      ...
      register(context, WILLOW_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.WILLOW.getLog()),
              ...
              new RandomizedIntBlockStateProvider(BlockStateProvider.of(HibiscusWoods.WILLOW.getWillowVines().getDefaultState()), DownwardVineBlock.AGE, UniformIntProvider.create(23, 25)),
      ...
      register(context,
              WILLOW_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.WILLOW_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.WILLOW_CHECKED)
              )
      );
      ...
      register(context, WHITE_WISTERIA_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.WISTERIA.getLog()),
              ...
              new RandomizedIntBlockStateProvider(BlockStateProvider.of(HibiscusWoods.WISTERIA.getWhiteWisteriaVines().getDefaultState()), DownwardVineBlock.AGE, UniformIntProvider.create(22, 25)),
      ...
      register(context, PINK_WISTERIA_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.WISTERIA.getLog()),
              ...
              new RandomizedIntBlockStateProvider(BlockStateProvider.of(HibiscusWoods.WISTERIA.getPinkWisteriaVines().getDefaultState()), DownwardVineBlock.AGE, UniformIntProvider.create(22, 25)),
      ...
      register(context, BLUE_WISTERIA_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.WISTERIA.getLog()),
              ...
              new RandomizedIntBlockStateProvider(BlockStateProvider.of(HibiscusWoods.WISTERIA.getBlueWisteriaVines().getDefaultState()), DownwardVineBlock.AGE, UniformIntProvider.create(22, 25)),
      ...
      register(context, PURPLE_WISTERIA_TREE, Feature.TREE, new TreeFeatureConfig.Builder(BlockStateProvider.of(HibiscusWoods.WISTERIA.getLog()),
              ...
              new RandomizedIntBlockStateProvider(BlockStateProvider.of(HibiscusWoods.WISTERIA.getPurpleWisteriaVines().getDefaultState()), DownwardVineBlock.AGE, UniformIntProvider.create(22, 25)),
      ...
      register(
              ...
              WISTERIA_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.WHITE_WISTERIA_CHECKED), 0.10f),
                      new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.BLUE_WISTERIA_CHECKED), 0.325f),
                      new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.PURPLE_WISTERIA_CHECKED), 0.325f),
                      new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.PINK_WISTERIA_CHECKED), 0.25f)
              ), placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.WHITE_WISTERIA_CHECKED))
      );
      ...
      register(context,
              SUGI_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.SUGI_CHECKED), 0.325f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.SUGI_CHECKED)
              )
      );
      ...
      register(context,
              LARGE_SUGI_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.LARGE_SUGI_CHECKED), 0.325f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.LARGE_SUGI_CHECKED)
              )
      );
      ...
      register(context,
              OLIVE_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.OLIVE_CHECKED), 0.325f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.OLIVE_CHECKED)
              )
      );
      ...
      register(context,
              ...
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.PALO_VERDE_CHECKED), 0.325f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.PALO_VERDE_CHECKED)
              )
      );
...
//              BANYAN_TREE_SPAWN,
//              Feature.RANDOM_SELECTOR,
//              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.BANYAN_CHECKED), 0.325f)),
//                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.BANYAN_CHECKED)
//              )
//      );
      ...
      register(context,
              SAXAUL_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.SAXAUL_CHECKED), 0.325f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.SAXAUL_CHECKED)
              )
      );
      ...
      register(context,
              CEDAR_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.CEDAR_CHECKED), 0.325f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.CEDAR_CHECKED)
              )
      );
      ...
      register(context,
              COCONUT_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.COCONUT_CHECKED), 0.325f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.COCONUT_CHECKED)
              )
      );
      ...
      register(context,
              GHAF_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.GHAF_CHECKED), 0.325f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.GHAF_CHECKED)
              )
      );
      ...
      register(
              ...
              JOSHUA_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.JOSHUA_CHECKED), 0.325f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.JOSHUA_CHECKED)
              )
      );
      ...
      register(
              ...
              ALLUAUDIA_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.ALLUAUDIA_CHECKED), 0.325f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.ALLUAUDIA_CHECKED)
              )
      );
      ...
      register(
              ...
              CYPRESS_TREE_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.CYPRESS_CHECKED), 0.325f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.CYPRESS_CHECKED)
              )
      );
      ...
      register(context,
              OAK_BUSH_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.OAK_BUSH_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.OAK_BUSH_CHECKED)
              )
      );
      ...
      register(
              ...
              SPRUCE_BUSH_SPAWN,
              Feature.RANDOM_SELECTOR,
              new RandomFeatureConfig(List.of(new RandomFeatureEntry(placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.SPRUCE_BUSH_CHECKED), 0.5f)),
                      placedFeatureRegistryEntryLookup.getOrThrow(NaturesSpiritPlacedFeatures.SPRUCE_BUSH_CHECKED)
              )
      );
      ...
      register(context,
              ...
              new TurnipRootFeatureConfig(PlacedFeatures.createEntry(Feature.NO_BONEMEAL_FLOWER, new RandomPatchFeatureConfig(30, 3, 2, PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK,
                      new SimpleBlockFeatureConfig(BlockStateProvider.of(HibiscusMiscBlocks.DESERT_TURNIP_STEM.getDefaultState().with(DesertTurnipStemBlock.AGE, 7))),
