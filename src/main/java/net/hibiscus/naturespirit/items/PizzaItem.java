...
public class PizzaItem extends AliasedBlockItem {
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        Item pizzaSlice = this.asItem() == HibiscusBlocks.WHOLE_PIZZA ? HibiscusBlocks.THREE_QUARTERS_PIZZA :
                this.asItem() == HibiscusBlocks.THREE_QUARTERS_PIZZA ? HibiscusBlocks.HALF_PIZZA :
                        this.asItem() == HibiscusBlocks.HALF_PIZZA ? HibiscusBlocks.QUARTER_PIZZA :
                                Items.AIR;
