...
public final class NSBoatEntityRenderer extends BoatEntityRenderer {
   public NSBoatEntityRenderer(EntityRendererFactory.Context context, boolean chest, NSBoatEntity.HibiscusBoat boatData) {
      super(context, chest);
      var id = boatData.id();
   ...
   public static EntityModelLayer getModelLayer(NSBoatEntity.HibiscusBoat boat, boolean chest) {
      var id = boat.id();
