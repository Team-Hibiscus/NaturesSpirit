...
public class MapleLeavesParticle extends SpriteBillboardParticle {
   ...
   public void tick() {
      ...
      if (!this.dead) {
         ...
         double d = Math.cos(Math.toRadians((double)(this.field_43370 * 60.0F))) * 1.85D * Math.pow((double)g, 1.25D);
         double e = Math.sin(Math.toRadians((double)(this.field_43370 * 60.0F))) * 1.85D * Math.pow((double)g, 1.25D);
