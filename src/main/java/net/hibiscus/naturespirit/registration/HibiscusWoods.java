...
public class HibiscusWoods {
   ...
   public static final Block XERIC_THATCH = registerBlock("xeric_thatch",
           new Block(AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).strength(0.4F).sounds(BlockSoundGroup.GRASS)), HibiscusItemGroups.NS_ITEM_GROUP, GHAF.getChestBoatItem());
   public static final Block XERIC_THATCH_STAIRS = registerBlock(
           "xeric_thatch_stairs",
           new StairsBlock(XERIC_THATCH.getDefaultState(), AbstractBlock.Settings.copy(XERIC_THATCH)), HibiscusItemGroups.NS_ITEM_GROUP
   );
   public static final Block XERIC_THATCH_SLAB = registerBlock("xeric_thatch_slab", new SlabBlock(AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).sounds(BlockSoundGroup.GRASS).strength(0.4f)), HibiscusItemGroups.NS_ITEM_GROUP);
   public static final Block XERIC_THATCH_CARPET = registerBlock("xeric_thatch_carpet",
           new CarpetBlock(AbstractBlock.Settings.create().mapColor(MapColor.YELLOW).strength(0F).pistonBehavior(PistonBehavior.DESTROY).sounds(BlockSoundGroup.GRASS)), HibiscusItemGroups.NS_ITEM_GROUP
   );
   ...
   public static final Block COCONUT_THATCH = registerBlock("coconut_thatch",
           new Block(AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_GRAY).strength(0.4F).sounds(BlockSoundGroup.GRASS)), HibiscusItemGroups.NS_ITEM_GROUP, COCONUT.getChestBoatItem());
   public static final Block COCONUT_THATCH_STAIRS = registerBlock(
           "coconut_thatch_stairs",
           new StairsBlock(COCONUT_THATCH.getDefaultState(), AbstractBlock.Settings.copy(COCONUT_THATCH)), HibiscusItemGroups.NS_ITEM_GROUP
   );
   public static final Block COCONUT_THATCH_SLAB = registerBlock("coconut_thatch_slab", new SlabBlock(AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_GRAY).sounds(BlockSoundGroup.GRASS).strength(0.4f)), HibiscusItemGroups.NS_ITEM_GROUP);
   public static final Block COCONUT_THATCH_CARPET = registerBlock("coconut_thatch_carpet",
           new CarpetBlock(AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_GRAY).strength(0F).pistonBehavior(PistonBehavior.DESTROY).sounds(BlockSoundGroup.GRASS)), HibiscusItemGroups.NS_ITEM_GROUP
   );
   ...
   ), HibiscusItemGroups.NS_ITEM_GROUP, Items.SWEET_BERRIES, 0.2F);
   public static final Block COCONUT_SPROUT = registerPlantBlock("coconut_sprout", new SproutingCoconutBlock(
           ...
           AbstractBlock.Settings.create().strength(1.0F).sounds(BlockSoundGroup.GRASS).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)
   ), HibiscusItemGroups.NS_ITEM_GROUP, PALO_VERDE.getSapling(), 0.2F);
   ...
   public static final Block EVERGREEN_THATCH = registerBlock("evergreen_thatch",
           new Block(AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_GRAY).strength(0.4F).sounds(BlockSoundGroup.GRASS)), HibiscusItemGroups.NS_ITEM_GROUP, LARCH.getChestBoatItem());
   public static final Block EVERGREEN_THATCH_STAIRS = registerBlock(
           "evergreen_thatch_stairs",
           new StairsBlock(EVERGREEN_THATCH.getDefaultState(), AbstractBlock.Settings.copy(EVERGREEN_THATCH)), HibiscusItemGroups.NS_ITEM_GROUP
   );
   public static final Block EVERGREEN_THATCH_SLAB = registerBlock("evergreen_thatch_slab", new SlabBlock(AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_GRAY).sounds(BlockSoundGroup.GRASS).strength(0.4f)), HibiscusItemGroups.NS_ITEM_GROUP);
