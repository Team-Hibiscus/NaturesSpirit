...
public class NSMiscBlocks {
   ...
   public static final Block PINK_SAND = registerBlock("pink_sand",
           new SandBlock(14331784, FabricBlockSettings.create().mapColor(MapColor.RAW_IRON_PINK).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)), NSItemGroups.NS_ITEM_GROUP
   );

   public static final Block PINK_SANDSTONE = registerBlock("pink_sandstone",
           new Block(FabricBlockSettings.create().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(0.8F)), NSItemGroups.NS_ITEM_GROUP
   );
   ...
   public static final Block CHISELED_PINK_SANDSTONE = registerBlock("chiseled_pink_sandstone", new Block(FabricBlockSettings.create().mapColor(MapColor.PALE_YELLOW).instrument(
           Instrument.BASEDRUM).requiresTool().strength(0.8F)), NSItemGroups.NS_ITEM_GROUP);
   ...
   public static final Block SMOOTH_PINK_SANDSTONE = registerBlock("smooth_pink_sandstone", new Block(FabricBlockSettings.create().mapColor(MapColor.PALE_YELLOW).instrument(
           Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F)), NSItemGroups.NS_ITEM_GROUP);

   public static final Block PINK_SANDSTONE_STAIRS = registerBlock(
           "pink_sandstone_stairs",
           new StairsBlock(PINK_SANDSTONE.getDefaultState(), FabricBlockSettings.copy(PINK_SANDSTONE)), NSItemGroups.NS_ITEM_GROUP
   );

   public static final Block SMOOTH_PINK_SANDSTONE_STAIRS = registerBlock("smooth_pink_sandstone_stairs",
           new StairsBlock(SMOOTH_PINK_SANDSTONE.getDefaultState(), FabricBlockSettings.copy(SMOOTH_PINK_SANDSTONE)), NSItemGroups.NS_ITEM_GROUP
   );
   ...
   public static final Block CUT_PINK_SANDSTONE_SLAB = registerBlock("cut_pink_sandstone_slab",
           new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F)), NSItemGroups.NS_ITEM_GROUP
   );

   public static final Block SMOOTH_PINK_SANDSTONE_SLAB = registerBlock("smooth_pink_sandstone_slab", new SlabBlock(FabricBlockSettings.copy(SMOOTH_PINK_SANDSTONE)), NSItemGroups.NS_ITEM_GROUP);

   public static final Block PINK_SANDSTONE_WALL = registerBlock("pink_sandstone_wall", new WallBlock(FabricBlockSettings.copy(PINK_SANDSTONE).solid()), NSItemGroups.NS_ITEM_GROUP);
   ...
   public static final Block ALLUAUDIA = registerPlantBlock("alluaudia", new GrowingBranchingTrunkBlock(FabricBlockSettings.create().pistonBehavior(PistonBehavior.DESTROY).mapColor(MapColor.GREEN).nonOpaque().sounds(BlockSoundGroup.VINE).hardness(.5f).strength(.5f).notSolid()), NSItemGroups.NS_ITEM_GROUP, Items.CACTUS, .2f);
   ...
   public static final Block ALLUAUDIA_BUNDLE = registerPlantBlock("alluaudia_bundle", new PillarBlock(FabricBlockSettings.create().mapColor(MapColor.GREEN).nonOpaque().sounds(BlockSoundGroup.VINE).hardness(.6f).strength(.6f)), NSItemGroups.NS_ITEM_GROUP, STRIPPED_ALLUAUDIA, .2f);
   public static final Block STRIPPED_ALLUAUDIA_BUNDLE = registerPlantBlock("stripped_alluaudia_bundle", new PillarBlock(FabricBlockSettings.create().mapColor(MapColor.OAK_TAN).nonOpaque().sounds(BlockSoundGroup.VINE).hardness(.6f).strength(.6f)), NSItemGroups.NS_ITEM_GROUP, ALLUAUDIA_BUNDLE, .2f);
   ...
   public static final Block PAPER_SIGN = registerBlock("paper_sign", new SignBlock(AbstractBlock.Settings.copy(NSWoods.SUGI.getSign()), PAPER_WOOD_TYPE));
   public static final Block PAPER_WALL_SIGN = registerBlock("paper_wall_sign", new WallSignBlock(AbstractBlock.Settings.copy(NSWoods.SUGI.getSign()).dropsLike(PAPER_SIGN), PAPER_WOOD_TYPE));
   public static final Block PAPER_HANGING_SIGN =  registerBlock("paper_hanging_sign", new HangingSignBlock(AbstractBlock.Settings.copy(NSWoods.SUGI.getHangingSign()), PAPER_WOOD_TYPE));
   public static final Block PAPER_WALL_HANGING_SIGN = registerBlock("paper_wall_hanging_sign", new WallHangingSignBlock(AbstractBlock.Settings.copy(NSWoods.SUGI.getHangingSign()).dropsLike(PAPER_HANGING_SIGN), PAPER_WOOD_TYPE));
   public static final Item PAPER_SIGN_ITEM = registerItem( "paper_sign", new SignItem(new FabricItemSettings().maxCount(16), PAPER_SIGN, PAPER_WALL_SIGN), NSItemGroups.NS_ITEM_GROUP, Items.WARPED_SIGN, ItemGroups.FUNCTIONAL);
   public static final Item PAPER_HANGING_SIGN_ITEM = registerItem( "paper_hanging_sign", new HangingSignItem(PAPER_HANGING_SIGN, PAPER_WALL_HANGING_SIGN, new FabricItemSettings().maxCount(16)), NSItemGroups.NS_ITEM_GROUP, PAPER_SIGN_ITEM, ItemGroups.FUNCTIONAL);
