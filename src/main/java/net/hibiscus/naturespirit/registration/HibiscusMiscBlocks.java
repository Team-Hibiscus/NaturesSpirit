...
public class HibiscusMiscBlocks {
   ...
   public static final Block RED_MOSS_BLOCK = registerBlock("red_moss_block", new RedMossBlock(AbstractBlock.Settings.create().mapColor(MapColor.RED).strength(0.1F).sounds(BlockSoundGroup.MOSS_BLOCK).pistonBehavior(PistonBehavior.DESTROY)), HibiscusItemGroups.NS_ITEM_GROUP, Items.MOSS_BLOCK, ItemGroups.NATURAL);
   public static final Block RED_MOSS_CARPET = registerBlock("red_moss_carpet", new CarpetBlock(AbstractBlock.Settings.create().mapColor(MapColor.RED).strength(0.1F).sounds(BlockSoundGroup.MOSS_CARPET).pistonBehavior(PistonBehavior.DESTROY)), HibiscusItemGroups.NS_ITEM_GROUP, Items.MOSS_CARPET, ItemGroups.NATURAL);
   ...
   public static final Block PINK_SAND = registerBlock("pink_sand",
           new SandBlock(14331784, FabricBlockSettings.create().mapColor(MapColor.RAW_IRON_PINK).instrument(Instrument.SNARE).strength(0.5F).sounds(BlockSoundGroup.SAND)), HibiscusItemGroups.NS_ITEM_GROUP
   );

   public static final Block PINK_SANDSTONE = registerBlock("pink_sandstone",
           new Block(FabricBlockSettings.create().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(0.8F)), HibiscusItemGroups.NS_ITEM_GROUP
   );
   ...
   public static final Block CHISELED_PINK_SANDSTONE = registerBlock("chiseled_pink_sandstone", new Block(FabricBlockSettings.create().mapColor(MapColor.PALE_YELLOW).instrument(
           Instrument.BASEDRUM).requiresTool().strength(0.8F)), HibiscusItemGroups.NS_ITEM_GROUP);
   ...
   public static final Block SMOOTH_PINK_SANDSTONE = registerBlock("smooth_pink_sandstone", new Block(FabricBlockSettings.create().mapColor(MapColor.PALE_YELLOW).instrument(
           Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F)), HibiscusItemGroups.NS_ITEM_GROUP);

   public static final Block PINK_SANDSTONE_STAIRS = registerBlock(
           "pink_sandstone_stairs",
           new StairsBlock(PINK_SANDSTONE.getDefaultState(), FabricBlockSettings.copy(PINK_SANDSTONE)), HibiscusItemGroups.NS_ITEM_GROUP
   );

   public static final Block SMOOTH_PINK_SANDSTONE_STAIRS = registerBlock("smooth_pink_sandstone_stairs",
           new StairsBlock(SMOOTH_PINK_SANDSTONE.getDefaultState(), FabricBlockSettings.copy(SMOOTH_PINK_SANDSTONE)), HibiscusItemGroups.NS_ITEM_GROUP
   );
   ...
   public static final Block CUT_PINK_SANDSTONE_SLAB = registerBlock("cut_pink_sandstone_slab",
           new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.PALE_YELLOW).instrument(Instrument.BASEDRUM).requiresTool().strength(2.0F, 6.0F)), HibiscusItemGroups.NS_ITEM_GROUP
   );

   public static final Block SMOOTH_PINK_SANDSTONE_SLAB = registerBlock("smooth_pink_sandstone_slab", new SlabBlock(FabricBlockSettings.copy(SMOOTH_PINK_SANDSTONE)), HibiscusItemGroups.NS_ITEM_GROUP);

   public static final Block PINK_SANDSTONE_WALL = registerBlock("pink_sandstone_wall", new WallBlock(FabricBlockSettings.copy(PINK_SANDSTONE).solid()), HibiscusItemGroups.NS_ITEM_GROUP);
   ...
   public static final Block GREEN_BEARBERRIES = registerPlantBlock("green_bearberries",
           new BearberriesBlock(FabricBlockSettings
                   .create()
                   .noCollision()
                   .replaceable()
                   .breakInstantly()
   ...
   public static final Block CATTAIL = registerPlantBlock("cattail",
           new CattailsBlock(FabricBlockSettings
                   .create()
                   .mapColor(MapColor.DARK_GREEN)
                   .noCollision()
                   .breakInstantly()
   ...
   public static final Item ORNATE_SUCCULENT_ITEM = registerPlantWallBlockItem("ornate_succulent", ORNATE_SUCCULENT, ORNATE_WALL_SUCCULENT, HibiscusItemGroups.NS_ITEM_GROUP, Items.PITCHER_PLANT, .5F);
   public static final Item DROWSY_SUCCULENT_ITEM = registerPlantWallBlockItem("drowsy_succulent", DROWSY_SUCCULENT, DROWSY_WALL_SUCCULENT, HibiscusItemGroups.NS_ITEM_GROUP, ORNATE_SUCCULENT_ITEM, .5F);
   public static final Item AUREATE_SUCCULENT_ITEM = registerPlantWallBlockItem("aureate_succulent", AUREATE_SUCCULENT, AUREATE_WALL_SUCCULENT, HibiscusItemGroups.NS_ITEM_GROUP, DROWSY_SUCCULENT_ITEM, .5F);
   public static final Item SAGE_SUCCULENT_ITEM = registerPlantWallBlockItem("sage_succulent", SAGE_SUCCULENT, SAGE_WALL_SUCCULENT, HibiscusItemGroups.NS_ITEM_GROUP, AUREATE_SUCCULENT_ITEM, .5F);
   public static final Item FOAMY_SUCCULENT_ITEM = registerPlantWallBlockItem("foamy_succulent", FOAMY_SUCCULENT, FOAMY_WALL_SUCCULENT, HibiscusItemGroups.NS_ITEM_GROUP, SAGE_SUCCULENT_ITEM, .5F);
   public static final Item IMPERIAL_SUCCULENT_ITEM = registerPlantWallBlockItem("imperial_succulent", IMPERIAL_SUCCULENT, IMPERIAL_WALL_SUCCULENT, HibiscusItemGroups.NS_ITEM_GROUP, FOAMY_SUCCULENT_ITEM, .5F);
   public static final Item REGAL_SUCCULENT_ITEM = registerPlantWallBlockItem("regal_succulent", REGAL_SUCCULENT, REGAL_WALL_SUCCULENT, HibiscusItemGroups.NS_ITEM_GROUP, IMPERIAL_SUCCULENT_ITEM, .5F);
   ...
   public static final Block SHIITAKE_MUSHROOM = registerPlantBlock("shiitake_mushroom", new ShiitakeMushroomPlantBlock(
           AbstractBlock.Settings
                   ...
                   .pistonBehavior(PistonBehavior.DESTROY),
           NaturesSpiritConfiguredFeatures.HUGE_SHIITAKE_MUSHROOM
   ), HibiscusItemGroups.NS_ITEM_GROUP, Blocks.RED_MUSHROOM, 0.1F);
   ...
   public static final Block GRAY_POLYPORE = registerPlantBlock("gray_polypore", new PolyporeBlock(
           AbstractBlock.Settings
                   ...
                   .postProcess(Blocks::always)
                   .pistonBehavior(PistonBehavior.DESTROY),
           NaturesSpiritConfiguredFeatures.GRAY_POLYPORE
   ), HibiscusItemGroups.NS_ITEM_GROUP, SHIITAKE_MUSHROOM, 0.1F);
   ...
   public static final Block LOTUS_STEM = registerPlantBlock("lotus_stem", new LotusStemBlock(FabricBlockSettings
           ...
           .nonOpaque()
           .breakInstantly()
           .sounds(BlockSoundGroup.LILY_PAD), LOTUS_FLOWER), HibiscusItemGroups.NS_ITEM_GROUP, LOTUS_FLOWER, 0.2F);
   ...
   public static final Block ALLUAUDIA_BUNDLE = registerPlantBlock("alluaudia_bundle", new PillarBlock(FabricBlockSettings.create().mapColor(MapColor.GREEN).nonOpaque().sounds(BlockSoundGroup.VINE).hardness(.6f).strength(.6f)), HibiscusItemGroups.NS_ITEM_GROUP, STRIPPED_ALLUAUDIA, .2f);
   public static final Block STRIPPED_ALLUAUDIA_BUNDLE = registerPlantBlock("stripped_alluaudia_bundle", new PillarBlock(FabricBlockSettings.create().mapColor(MapColor.OAK_TAN).nonOpaque().sounds(BlockSoundGroup.VINE).hardness(.6f).strength(.6f)), HibiscusItemGroups.NS_ITEM_GROUP, ALLUAUDIA_BUNDLE, .2f);
   ...
   public static final Block DESERT_TURNIP_STEM = HibiscusRegistryHelper.registerPlantBlock("desert_turnip_stem", new DesertTurnipStemBlock((DesertTurnipBlock) DESERT_TURNIP_BLOCK,
   ...
   public static final Item CHEESE_ARROW = HibiscusConfig.cheese_arrow ? registerItem("cheese_arrow", new CheeseArrowItem(new Item.Settings()), HibiscusItemGroups.NS_ITEM_GROUP, Items.SPECTRAL_ARROW, ItemGroups.COMBAT) : null;
   ...
   public static final Block CALCITE_CLUSTER = registerBlock("calcite_cluster", new AmethystClusterBlock(7,
           ...
           FabricBlockSettings
                   ...
                   .strength(1.5F)
                   .pistonBehavior(PistonBehavior.DESTROY)
   ), HibiscusItemGroups.NS_ITEM_GROUP, Blocks.AMETHYST_CLUSTER, ItemGroups.NATURAL);
   ...
   public static final Item PAPER_SIGN_ITEM = registerItem( "paper_sign", new SignItem(new FabricItemSettings().maxCount(16), PAPER_SIGN, PAPER_WALL_SIGN), HibiscusItemGroups.NS_ITEM_GROUP, Items.WARPED_SIGN, ItemGroups.FUNCTIONAL);
   public static final Item PAPER_HANGING_SIGN_ITEM = registerItem( "paper_hanging_sign", new HangingSignItem(PAPER_HANGING_SIGN, PAPER_WALL_HANGING_SIGN, new FabricItemSettings().maxCount(16)), HibiscusItemGroups.NS_ITEM_GROUP, PAPER_SIGN_ITEM, ItemGroups.FUNCTIONAL);
