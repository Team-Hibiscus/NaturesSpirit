...
public class HibiscusBlocksAndItems {
   ...
   public static final Block SHIITAKE_MUSHROOM_BLOCK = registerBlock(
           ...
           new MushroomBlock(FabricBlockSettings.create()
                   .mapColor(MapColor.DIRT_BROWN)
   ...
   public static final Item LOTUS_FLOWER_ITEM = registerItem(
           "lotus_flower", new PlaceableOnWaterItem(LOTUS_FLOWER, new Item.Settings()),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
           Items.LILY_PAD,
           ItemGroups.NATURAL
   );
   ...
   public static final Block CALCITE_CLUSTER = registerBlock(
           ...
           new AmethystClusterBlock(7,
                   3,
                   FabricBlockSettings.create().mapColor(MapColor.WHITE).solid().nonOpaque().ticksRandomly().sounds(
                           BlockSoundGroup.CALCITE).strength(1.5F).pistonBehavior(PistonBehavior.DESTROY)
           ),
           HibiscusItemGroups.NATURES_SPIRIT_ITEM_GROUP,
