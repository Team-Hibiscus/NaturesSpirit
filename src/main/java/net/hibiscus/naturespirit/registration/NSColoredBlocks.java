...
public class NSColoredBlocks {
	...
	public static final Block PAPER_LANTERN = registerTransparentBlock("paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), Items.PINK_CANDLE, ItemGroups.COLORED_BLOCKS, Items.SOUL_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block WHITE_PAPER_LANTERN = registerTransparentBlock("white_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block LIGHT_GRAY_PAPER_LANTERN = registerTransparentBlock("light_gray_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), WHITE_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, WHITE_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block GRAY_PAPER_LANTERN = registerTransparentBlock("gray_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), LIGHT_GRAY_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, LIGHT_GRAY_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block BLACK_PAPER_LANTERN = registerTransparentBlock("black_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), GRAY_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, GRAY_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block BROWN_PAPER_LANTERN = registerTransparentBlock("brown_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), BLACK_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, BLACK_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block RED_PAPER_LANTERN = registerTransparentBlock("red_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), BROWN_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, BROWN_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block ORANGE_PAPER_LANTERN = registerTransparentBlock("orange_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), RED_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, RED_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block YELLOW_PAPER_LANTERN = registerTransparentBlock("yellow_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), ORANGE_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, ORANGE_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block LIME_PAPER_LANTERN = registerTransparentBlock("lime_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), YELLOW_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, YELLOW_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block GREEN_PAPER_LANTERN = registerTransparentBlock("green_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), LIME_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, LIME_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block BLUE_PAPER_LANTERN = registerTransparentBlock("blue_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), GREEN_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, GREEN_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block LIGHT_BLUE_PAPER_LANTERN = registerTransparentBlock("light_blue_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), BLUE_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, BLUE_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block CYAN_PAPER_LANTERN = registerTransparentBlock("cyan_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), LIGHT_BLUE_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, LIGHT_BLUE_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block PURPLE_PAPER_LANTERN = registerTransparentBlock("purple_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), CYAN_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, CYAN_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block MAGENTA_PAPER_LANTERN = registerTransparentBlock("magenta_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), PURPLE_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, PURPLE_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	public static final Block PINK_PAPER_LANTERN = registerTransparentBlock("pink_paper_lantern", new PaperLanternBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().strength(0.5F).sounds(BlockSoundGroup.LANTERN).luminance((state) -> 15).nonOpaque().pistonBehavior(PistonBehavior.DESTROY)), MAGENTA_PAPER_LANTERN, ItemGroups.COLORED_BLOCKS, MAGENTA_PAPER_LANTERN, ItemGroups.FUNCTIONAL);
	...
	public static final Block KAOLIN_STAIRS = registerBlock(
		"kaolin_stairs",
		new StairsBlock(KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.ORANGE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
		PINK_KAOLIN,
		ItemGroups.COLORED_BLOCKS
	);
	public static final Block WHITE_KAOLIN_STAIRS = registerBlock(
		"white_kaolin_stairs",
		new StairsBlock(WHITE_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_WHITE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
		KAOLIN_STAIRS,
		ItemGroups.COLORED_BLOCKS
	);
	...
	public static final Block GRAY_KAOLIN_STAIRS = registerBlock(
		"gray_kaolin_stairs",
		new StairsBlock(GRAY_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_GRAY).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block BLACK_KAOLIN_STAIRS = registerBlock(
		"black_kaolin_stairs",
		new StairsBlock(BLACK_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_BLACK).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block BROWN_KAOLIN_STAIRS = registerBlock(
		"brown_kaolin_stairs",
		new StairsBlock(BROWN_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_BROWN).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block RED_KAOLIN_STAIRS = registerBlock(
		"red_kaolin_stairs",
		new StairsBlock(RED_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_RED).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
		BROWN_KAOLIN_STAIRS,
		ItemGroups.COLORED_BLOCKS
	);
	public static final Block ORANGE_KAOLIN_STAIRS = registerBlock(
		"orange_kaolin_stairs",
		new StairsBlock(ORANGE_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_ORANGE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
		RED_KAOLIN_STAIRS,
		ItemGroups.COLORED_BLOCKS
	);
	public static final Block YELLOW_KAOLIN_STAIRS = registerBlock(
		"yellow_kaolin_stairs",
		new StairsBlock(YELLOW_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_YELLOW).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block LIME_KAOLIN_STAIRS = registerBlock(
		"lime_kaolin_stairs",
		new StairsBlock(LIME_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_LIME).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block GREEN_KAOLIN_STAIRS = registerBlock(
		"green_kaolin_stairs",
		new StairsBlock(GREEN_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_GREEN).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block CYAN_KAOLIN_STAIRS = registerBlock(
		"cyan_kaolin_stairs",
		new StairsBlock(CYAN_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_CYAN).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block BLUE_KAOLIN_STAIRS = registerBlock(
		"blue_kaolin_stairs",
		new StairsBlock(BLUE_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_BLUE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block PURPLE_KAOLIN_STAIRS = registerBlock(
		...
		new StairsBlock(PURPLE_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_PURPLE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block MAGENTA_KAOLIN_STAIRS = registerBlock(
		...
		new StairsBlock(MAGENTA_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_MAGENTA).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block PINK_KAOLIN_STAIRS = registerBlock(
		"pink_kaolin_stairs",
		new StairsBlock(PINK_KAOLIN.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_PINK).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block KAOLIN_BRICK_STAIRS = registerBlock(
		"kaolin_brick_stairs",
		new StairsBlock(KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.ORANGE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block WHITE_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(WHITE_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_WHITE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block GRAY_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(GRAY_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_GRAY).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block BLACK_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(BLACK_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_BLACK).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block BROWN_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(BROWN_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_BROWN).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block RED_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(RED_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_RED).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block ORANGE_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(ORANGE_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_ORANGE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block YELLOW_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(YELLOW_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_YELLOW).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block LIME_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(LIME_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_LIME).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block GREEN_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(GREEN_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_GREEN).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block CYAN_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(CYAN_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_CYAN).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block BLUE_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(BLUE_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_BLUE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block PURPLE_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(PURPLE_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_PURPLE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block MAGENTA_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(MAGENTA_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_MAGENTA).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block PINK_KAOLIN_BRICK_STAIRS = registerBlock(
		...
		new StairsBlock(PINK_KAOLIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_PINK).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(1.25F, 4.2F)),
	...
	public static final Block WHITE_CHALK_STAIRS = registerBlock(
		"white_chalk_stairs",
		new StairsBlock(WHITE_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_WHITE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block GRAY_CHALK_STAIRS = registerBlock(
		"gray_chalk_stairs",
		new StairsBlock(GRAY_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_GRAY).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block BLACK_CHALK_STAIRS = registerBlock(
		"black_chalk_stairs",
		new StairsBlock(BLACK_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_BLACK).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block BROWN_CHALK_STAIRS = registerBlock(
		"brown_chalk_stairs",
		new StairsBlock(BROWN_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_BROWN).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block RED_CHALK_STAIRS = registerBlock(
		"red_chalk_stairs",
		new StairsBlock(RED_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_RED).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block ORANGE_CHALK_STAIRS = registerBlock(
		"orange_chalk_stairs",
		new StairsBlock(ORANGE_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_ORANGE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block YELLOW_CHALK_STAIRS = registerBlock(
		"yellow_chalk_stairs",
		new StairsBlock(YELLOW_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_YELLOW).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block LIME_CHALK_STAIRS = registerBlock(
		"lime_chalk_stairs",
		new StairsBlock(LIME_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_LIME).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block GREEN_CHALK_STAIRS = registerBlock(
		"green_chalk_stairs",
		new StairsBlock(GREEN_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_GREEN).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block CYAN_CHALK_STAIRS = registerBlock(
		"cyan_chalk_stairs",
		new StairsBlock(CYAN_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_CYAN).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block BLUE_CHALK_STAIRS = registerBlock(
		"blue_chalk_stairs",
		new StairsBlock(BLUE_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_BLUE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block PURPLE_CHALK_STAIRS = registerBlock(
		"purple_chalk_stairs",
		new StairsBlock(PURPLE_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_PURPLE).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block MAGENTA_CHALK_STAIRS = registerBlock(
		...
		new StairsBlock(MAGENTA_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_MAGENTA).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
	...
	public static final Block PINK_CHALK_STAIRS = registerBlock(
		"pink_chalk_stairs",
		new StairsBlock(PINK_CHALK.getDefaultState(), AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_PINK).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().strength(0.5F)),
