...
public class NSTags {
  ...
  public static class Items {
    ...
    public static final TagKey<Item> C_AXES = createCTag("axes");

    private static TagKey<Item> createTag(String name) {
      return TagKey.create(Registries.ITEM, NaturesSpirit.id(name));
    }
  ...
  public static class Blocks {
    ...
    private static TagKey<Block> createTag(String name) {
      return TagKey.create(Registries.BLOCK, NaturesSpirit.id(name));
    }
  }
}
