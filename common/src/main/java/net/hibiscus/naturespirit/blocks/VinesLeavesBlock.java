...
public class VinesLeavesBlock extends LeavesBlock implements BonemealableBlock {
  ...
  public NSBlockHolder<DownwardsVinePlantBlock> vinePlantBlock;
  public NSBlockHolder<DownwardVineBlock> vineTipBlock;

  public VinesLeavesBlock(Properties properties, NSBlockHolder<DownwardsVinePlantBlock> vinePlantBlockInput, NSBlockHolder<DownwardVineBlock> vineTipBlockInput) {
    super(0F, properties);
