...
public class DownwardsVinePlantBlock extends GrowingPlantBodyBlock {
  ...
  public NSBlockHolder<DownwardVineBlock> headBlock;

  public DownwardsVinePlantBlock(Properties properties, NSBlockHolder<DownwardVineBlock> headBlock) {
    super(properties.overrideDescription(Util.makeDescriptionId("block", headBlock.getId())), Direction.DOWN, SHAPE, false);
