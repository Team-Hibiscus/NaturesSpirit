...
public record PizzaToppingVariant(
        int hunger, float saturation, Identifier itemId, Identifier texturePath, String translationKey
) {
    ...
    static {
        PACKET_CODEC = StreamCodec.composite(ByteBufCodecs.VAR_INT, PizzaToppingVariant::hunger, ByteBufCodecs.FLOAT, PizzaToppingVariant::saturation, Identifier.STREAM_CODEC,
                PizzaToppingVariant::itemId, Identifier.STREAM_CODEC, PizzaToppingVariant::texturePath, ByteBufCodecs.STRING_UTF8, PizzaToppingVariant::translationKey, PizzaToppingVariant::new);
        ENTRY_CODEC = RegistryFileCodec.create(NaturesSpirit.PIZZA_TOPPING_VARIANT, CODEC);
        ENTRY_PACKET_CODEC = ByteBufCodecs.holder(NaturesSpirit.PIZZA_TOPPING_VARIANT, PACKET_CODEC);
    }
}
