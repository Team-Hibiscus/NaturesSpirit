...
public class CheeseBlock extends CakeBlock implements BucketPickup {
  ...
  @Override
  public ItemStack pickupBlock(LivingEntity user, LevelAccessor world, BlockPos pos, BlockState state) {
  ...
  protected InteractionResult useItemOn(ItemStack stack, BlockState state, Level world, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hit) {
    return stack.is(Items.BUCKET) && state.getValue(BITES) == 0 ? InteractionResult.PASS : super.useItemOn(stack, state, world, pos, player, hand, hit);
  }
  @Override
