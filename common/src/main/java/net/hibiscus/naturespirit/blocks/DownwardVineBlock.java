...
public class DownwardVineBlock extends GrowingPlantHeadBlock {
  ...
  private final Supplier<NSBlockHolder<DownwardsVinePlantBlock>> vinesPlantBlock;

  public DownwardVineBlock(Properties properties, Supplier<NSBlockHolder<DownwardsVinePlantBlock>> vinesPlantBlock) {
