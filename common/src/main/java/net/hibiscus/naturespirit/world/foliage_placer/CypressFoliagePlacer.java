...
public class CypressFoliagePlacer extends FoliagePlacer {
  ...
  protected FoliagePlacerType<?> type() {
    return NSWorldGen.CYPRESS_FOLIAGE_PLACER_TYPE.get();
  }
  ...
  protected void placeLeavesRow(WorldGenLevel world, FoliageSetter placer, RandomSource random, TreeConfiguration config, BlockPos centerPos, int radius, int y, boolean giantTrunk) {
  ...
  protected void generateDiagonalSqaure(WorldGenLevel world, FoliageSetter placer, RandomSource random, TreeConfiguration config, BlockPos centerPos, int radius, int y,
      boolean giantTrunk) {
    int i = giantTrunk ? 1 : 0;
    BlockPos.MutableBlockPos mutable = new BlockPos.MutableBlockPos();
