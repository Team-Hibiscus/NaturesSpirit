...
public class SaxaulTrunkPlacer extends TrunkPlacer {
  ...
  public static final MapCodec<SaxaulTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
    return trunkPlacerParts(instance).and(instance.group(IntProviders.POSITIVE_CODEC.fieldOf("extra_branch_steps").forGetter((trunkPlacer) -> {
    ...
    }), IntProviders.NON_NEGATIVE_CODEC.fieldOf("extra_branch_length").forGetter((trunkPlacer) -> {
  ...
  private void generateExtraBranch(WorldGenLevel world, BiConsumer<BlockPos, BlockState> replacer, RandomSource random, TreeConfiguration config, List<FoliageAttachment> nodes, BlockPos pos,
  ...
  private void generateSecondaryBranch(WorldGenLevel world, BiConsumer<BlockPos, BlockState> replacer, RandomSource random, TreeConfiguration config, List<FoliageAttachment> nodes, BlockPos pos,
