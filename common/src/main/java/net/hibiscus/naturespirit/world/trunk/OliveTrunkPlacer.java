...
public class OliveTrunkPlacer extends TrunkPlacer {
  ...
  private void generateExtraBranch(WorldGenLevel world, BiConsumer<BlockPos, BlockState> replacer, RandomSource random, TreeConfiguration config, List<FoliageAttachment> nodes,
