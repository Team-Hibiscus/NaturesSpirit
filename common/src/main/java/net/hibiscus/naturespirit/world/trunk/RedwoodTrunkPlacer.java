...
public class RedwoodTrunkPlacer extends TrunkPlacer {
  ...
  public List<FoliagePlacer.FoliageAttachment> placeTrunk(WorldGenLevel world, BiConsumer<BlockPos, BlockState> replacer, RandomSource random, int height, BlockPos startPos,
    ...
    placeBelowTrunkBlock(world, replacer, random, blockPos.north().east(), config);
    placeBelowTrunkBlock(world, replacer, random, blockPos.north().west(), config);
    placeBelowTrunkBlock(world, replacer, random, blockPos.north(), config);
    placeBelowTrunkBlock(world, replacer, random, blockPos.west(), config);
    ...
    placeBelowTrunkBlock(world, replacer, random, blockPos.south().west(), config);
