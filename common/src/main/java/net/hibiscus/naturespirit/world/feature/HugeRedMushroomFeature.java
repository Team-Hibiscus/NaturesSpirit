...
public class HugeRedMushroomFeature extends HugeMushroomFeature {
  ...
  protected void generateCap(WorldGenLevel world, RandomSource random, BlockPos start, int y, BlockPos.MutableBlockPos mutable, HugeMushroomFeatureConfig config) {
    for (int i = y - 3; i <= y; ++i) {
