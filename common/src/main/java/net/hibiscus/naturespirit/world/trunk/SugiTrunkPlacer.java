...
public class SugiTrunkPlacer extends TrunkPlacer {
  ...
  private void generateExtraBranch(WorldGenLevel world, BiConsumer<BlockPos, BlockState> replacer, RandomSource random, int height, TreeConfiguration config, List<FoliageAttachment> nodes,
